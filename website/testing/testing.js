...
{
 "use strict";
 var Global,FsRoot,TestingJS,Test,WebSharper,Operators,LibraryJS,AppFramework,EventTarget,Node,WindowOrWorkerGlobalScope,JavaScript,JS,SC$1,UI,Client,Templates,Obj,Doc,Pervasives,Library,String,Strings,Slice,ParseO,Unchecked,Numeric,System,Guid,List,T,Lazy,WebComponent,WcTabStrip,WcTabStripT,ListModel,PlugIn,Var$1,Var,View,Templating,Runtime,Server,TemplateInstance,Arrays,ProviderBuilder,Handler,LayoutEngine_Templates,GeneratedPrintf,LayoutEngine_GeneratedPrintf,Seq,PlugInDoc,WcSplitter,LayoutEngineModule,Collections,Dictionary,Docs,DateUtil,LazyExtensionsProxy,LazyRecord,PlugInVar,PlugInAction,PlugInQuery,ConcreteVar,Snap,FromView,List$1,Utils,HashSet,Client$1,Enumerator,T$1,WcSplitterT,SC$2,DomUtility,An,Settings,Abbrev,Mailbox,AttrProxy,HtmlModule,attr,Hoverable,Hoverable$1,CancellationTokenSource,Storage,Fresh,Object,CheckedInput,DictionaryUtil,Event,UIEvent,ResizeObserver,AttrModule,Array,LayoutEngine,Prepare,KeyCollection,DocElemNode,CharacterData,Docs$1,RunState,NodeSet,Anims,SC$3,Elt,Error,AggregateException,Concurrency,ArrayStorage,Attrs,Attrs$1,Dyn,SC$4,AppendList,FormatException,Updates,SC$5,CT,AsyncBody,SC$6,SC$7,DynamicAttrNode,SC$8,Easing,HashSet$1,HashSetUtil,Scheduler,OperationCanceledException,Queue,DomNodes,SC$9,String$1,Char,console,IntelliFactory,Runtime$1,$,Math,Reflect,Date;
 Global=self;
 ...
 SC$4=Global.StartupCode$WebSharper_UI$Animation=Global.StartupCode$WebSharper_UI$Animation||{};
 ...
 SC$4.$cctor=function()
 {
  ...
  SC$4.CubicInOut=Easing.Custom(function(t)
  {
   var t2;
   t2=t*t;
   return 3*t2-2*(t2*t);
  });
  SC$4.UseAnimations=true;
 };
