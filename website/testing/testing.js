...
{
 "use strict";
 var Global,FsRoot,TestingJS,Msal,PreambleState,WebSharper,Operators,testing_GeneratedPrintf,GeneratedPrintf,SC$1,EventTarget,WindowOrWorkerGlobalScope,JavaScript,JS,Unchecked,Arrays,Seq,Obj,UI,Var$1,Var,View,LibraryJS,Msal$1,AuthenticationParameters,Promise,List,T,HtmlModule,attr,Utils,ViewBuilder,Configuration,AuthOptions,Policy,Doc,Pervasives,Node,Library,String,Pojo,Strings,Slice,Enumerator,ConcreteVar,Snap,Abbrev,Fresh,Object,Concurrency,Account,AttrModule,AttrProxy,T$1,Array,Client,Templates,AsyncBody,SC$2,Error,NonStandardPromiseRejectionException,CT,Attrs,DomUtility,Docs,Collections,Dictionary,SC$3,Scheduler,CancellationTokenSource,DynamicAttrNode,Elt,FSharpMap,DocElemNode,CharacterData,SC$4,HashSet,An,Settings,Mailbox,OperationCanceledException,Char,SC$5,Updates,Pair,Attrs$1,Dyn,DictionaryUtil,Prepare,KeyCollection,Docs$1,RunState,NodeSet,Anims,SC$6,Queue,SC$7,SC$8,AppendList,BalancedTree,Easing,HashSet$1,HashSetUtil,DomNodes,Lazy,SC$9,LazyExtensionsProxy,LazyRecord,console,IntelliFactory,Runtime,$,Date;
 Global=self;
