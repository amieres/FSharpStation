...
{
 "use strict";
 var Global,FsRoot,TestingJS,Button,SC$1,WebSharper,Operators,JavaScript,JS,Utils,Obj,EventTarget,Node,UI,Doc,AttrProxy,Pervasives,Unchecked,Client,Templates,WindowOrWorkerGlobalScope,View,DomUtility,Attrs,Collections,Dictionary,Docs,Snap,SC$2,Arrays,HashSet,Seq,An,Settings,Abbrev,Mailbox,Elt,Array,DocElemNode,CharacterData,SC$3,DictionaryUtil,Object,Prepare,Slice,Enumerator,KeyCollection,Docs$1,RunState,NodeSet,Anims,SC$4,Updates,List,T,Attrs$1,Dyn,Strings,Fresh,SC$5,Concurrency,AppendList,SC$6,T$1,Easing,AsyncBody,SC$7,CT,HashSet$1,SC$8,Scheduler,CancellationTokenSource,DomNodes,HashSetUtil,Error,OperationCanceledException,Lazy,SC$9,LazyExtensionsProxy,LazyRecord,Queue,Date,IntelliFactory,Runtime,console,$;
 Global=self;
