(function()
{
 ...
 Rpc$1.obtenerListaDocs=function()
 {
  ...
  function f()
  {
   return(new AjaxRemotingProvider.New()).Async("testing:FsRoot.ProzperServer+Rpc.obtenerListaDocs:736140527",[Aliado$2.get_LoggedId()]);
  }
  b=Monads.asyncResult();
  return b.Run(b.Delay(function()
  {
 ...
 Rpc$1.obtenerFormasDePago=function()
 {
  ...
  function f()
  {
   return(new AjaxRemotingProvider.New()).Async("testing:FsRoot.ProzperServer+Rpc.obtenerFormasDePagoId:-600551380",[Aliado$2.get_LoggedId()]);
  }
  b=Monads.asyncResult();
  return b.Run(b.Delay(function()
  {
