{
  ...
  "modules": [
    {
      "moName": "FsRoot.Library+AssemblyData+ModuleName",
      "methods": []
    },
    {
      "moName": "FsRoot.Library+AssemblyData+TypeName",
      "methods": []
    },
    {
      "moName": "FsRoot.Library+AssemblyData+MethodName",
      "methods": []
    },
    {
      "moName": "FsRoot.Library+AssemblyData+AssemblyName",
      "methods": []
    },
    {
      "moName": "FsRoot.Library+AssemblyData+AssemblyRef",
      "methods": []
    },
    {
      "moName": "FsRoot.Library+AssemblyData+JSCode",
      "methods": []
    },
    {
      "moName": "FsRoot.Library+AssemblyData+Resource",
      "methods": []
    },
    {
      "moName": "FsRoot.Library+AssemblyData+ModuleRef",
      "methods": []
    },
    {
      "moName": "FsRoot.Library+AssemblyData+TypeRef",
      "methods": []
    },
    {
      "moName": "FsRoot.Library+AssemblyData+MethodDef",
      "methods": []
    },
    {
      "moName": "FsRoot.Library+AssemblyData+ModuleDef",
      "methods": []
    },
    {
      "moName": "FsRoot.Library+AssemblyData+AssemblyDef",
      "methods": []
    },
    {
      "moName": "FsRoot.Library+AssemblyData+LoadAsm",
      "methods": []
    },
    {
      "moName": "FsRoot.Library+AssemblyData",
      "methods": []
    },
    {
    ...
    {
      "moName": "FsRoot.TestingJS+AssemblyUI+LoadAsm",
      "methods": [
        {
          "meName": "fetchAsmData",
          "isField": 0,
          "type": {
            "tName": "Async<FsRoot.Library+AssemblyData+AssemblyDef>",
            "asm": "FSharp.Core"
          },
          "parms": [
            {
            ...
            {
              "tName": "FsRoot.Library+AssemblyData+AssemblyRef",
              "asm": "testing"
            }
          ]
        }
    ...
    {
      "moName": "FsRoot.TestingJS+AssemblyUI",
      "methods": [
        {
        ...
        },
        {
          ...
          "parms": [
            {
              "tName": "FsRoot.Library+AssemblyData+AssemblyDef",
              "asm": "testing"
            }
          ]
        },
        ...
        },
        {
          ...
          "parms": [
            {
              "tName": "(FsRoot.Library+AssemblyData+MethodDef -> bool)",
              "asm": "FSharp.Core"
            },
            {
              "tName": "FsRoot.Library+AssemblyData+AssemblyDef",
            ...
            {
              "tName": "(FsRoot.Library+AssemblyData+ModuleDef -> (FsRoot.Library+AssemblyData+MethodDef -> 'a))",
              "asm": "FSharp.Core"
            }
          ]
        },
        {
          ...
          "isField": 1,
          "type": {
            "tName": "Var<Option<(FsRoot.Library+AssemblyData+ModuleName * FsRoot.Library+AssemblyData+MethodName)>>",
            "asm": "WebSharper.UI"
          },
          "parms": []
        },
        ...
        },
        {
          ...
          "isField": 1,
          "type": {
            "tName": "Var<Option<FsRoot.Library+AssemblyData+AssemblyName>>",
            "asm": "WebSharper.UI"
          },
          "parms": []
        },
        ...
        },
        {
          ...
          "parms": [
            {
              "tName": "IEnumerable<FsRoot.Library+AssemblyData+AssemblyDef>",
              "asm": "netstandard"
            }
          ]
        },
        ...
        },
        {
          ...
          "isField": 1,
          "type": {
            "tName": "ListModel<FsRoot.Library+AssemblyData+AssemblyName, FsRoot.Library+AssemblyData+AssemblyDef>",
            "asm": "WebSharper.UI"
          },
          "parms": []
        },
        {
          ...
          "parms": [
            {
              "tName": "(FsRoot.Library+AssemblyData+AssemblyRef -> bool)",
              "asm": "FSharp.Core"
            },
            {
              "tName": "(FsRoot.Library+AssemblyData+AssemblyDef -> unit)",
              "asm": "FSharp.Core"
            },
            {
              "tName": "(FsRoot.Library+AssemblyData+AssemblyRef -> Async<FsRoot.Library+AssemblyData+AssemblyDef>)",
              "asm": "FSharp.Core"
            },
            {
              "tName": "FsRoot.Library+AssemblyData+AssemblyRef",
