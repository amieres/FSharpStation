...
(function()
{
 ...
 MainProgram.mainProgram=function()
 {
  ...
  {
   var b$1,p$1,i;
   return Unchecked.Equals(al.id,Aliado$2.empty().id)?(b$1=ProviderBuilder.Make(),(p$1=Handler.CompleteHoles(b$1.k,b$1.h,[]),(i=new TemplateInstance.New(p$1[1],MainProgram_Templates.opcionesadministrador(p$1[0])),(b$1.i=i,i)))).get_Doc():Doc.get_Empty();
  },ModeloUI.aliadoW());
 ...
 Rpc.obtenerListaDocs=function()
 {
  ...
  function f()
  {
   return(new AjaxRemotingProvider.New()).Async("MainProgram:FsRoot.ProzperServer+Rpc.obtenerListaDocs:543001906",[Aliado.get_LoggedId()]);
  }
  b=Monads.asyncResult();
  return b.Run(b.Delay(function()
  {
 ...
 Rpc.obtenerFormasDePago=function()
 {
  ...
  function f()
  {
   return(new AjaxRemotingProvider.New()).Async("MainProgram:FsRoot.ProzperServer+Rpc.obtenerFormasDePagoId:918783815",[Aliado.get_LoggedId()]);
  }
  b=Monads.asyncResult();
  return b.Run(b.Delay(function()
  {
...
//# sourceMappingURL=MainProgram.map
