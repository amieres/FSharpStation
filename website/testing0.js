...
{
 "use strict";
 var Global,FsRoot,TestingJS,Button,WebSharper,Operators,JavaScript,JS,EventTarget,Node,Obj,UI,Doc,AttrProxy,Client,Templates,Pervasives,WindowOrWorkerGlobalScope,View,DomUtility,Attrs,Collections,Dictionary,Docs,Snap,SC$1,Arrays,HashSet,Unchecked,Seq,An,Settings,Abbrev,Mailbox,Elt,Array,DocElemNode,CharacterData,SC$2,DictionaryUtil,Object,Prepare,Slice,Enumerator,KeyCollection,Docs$1,RunState,NodeSet,Anims,SC$3,Updates,List,T,Attrs$1,Dyn,Strings,Fresh,SC$4,Concurrency,AppendList,SC$5,T$1,Easing,AsyncBody,SC$6,CT,HashSet$1,SC$7,Scheduler,CancellationTokenSource,DomNodes,HashSetUtil,Error,OperationCanceledException,Lazy,SC$8,LazyExtensionsProxy,LazyRecord,Queue,IntelliFactory,Runtime,console,$,Date;
 Global=self;
 ...
 SC$1=Global.StartupCode$WebSharper_UI$Templates=Global.StartupCode$WebSharper_UI$Templates||{};
 ...
 Button.main=function()
 {
  ...
  })],[Doc.TextNode("Press Me!")]),Doc.TextNode(" It should respond 'Hello!'")]);
 ...
 {
  SC$1.$cctor();
  return SC$1.LocalTemplatesLoaded;
 };
 Templates.set_LocalTemplatesLoaded=function($1)
 {
  SC$1.$cctor();
  SC$1.LocalTemplatesLoaded=$1;
 };
 ...
 SC$1.$cctor=function()
 {
  ...
  SC$1.LoadedTemplates=new Dictionary.New$5();
  SC$1.LocalTemplatesLoaded=false;
  SC$1.TextHoleRE="\\${([^}]+)}";
 };
