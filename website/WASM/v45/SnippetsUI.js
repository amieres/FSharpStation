(function()
{
 ...
 SnippetsUI.installPresence=function()
 {
  SC$1.$cctor();
  return SC$1.installPresence;
 };
 ...
 SnippetsUI.calcUI$989$44=function(k)
 {
  return function(ev)
  {
 ...
 SnippetsUI.calcUI$988$44=function(k)
 {
  return function(ev)
  {
   View$1.Get(function(a)
 ...
 SnippetsUI.calcUI$987$44=function(k)
 {
  return function(ev)
  {
   View$1.Get(function(a)
 ...
 SnippetsUI.calcUI$978$44=function(snpdW,snp)
 {
  return function()
  {
 ...
 SnippetsUI.calcUI$972$44=function(lmd,snp)
 {
  return function()
  {
   var preds,x,v;
   preds=Var$1.Lens(lmd.get_CurrentV(),function($1)
   {
    return $1.snpPredIds;
   },function($1,$2)
   {
   ...
   preds.Set((x=preds.Get(),(((v=snp.Get().snpId,preds.Get().Contains(v))?function(v$1)
   {
    return function(s)
    {
     return s.Remove(v$1);
 ...
 SnippetsUI.calcUI$966$44=function(k,lmd)
 {
  return function()
  {
   var o;
 ...
 SnippetsUI.calcUI=function(wrapper,allowDelete,lmd)
 {
  ...
  return function(k)
  {
   return function(snp)
   {
    var snpdW,b,t,t$1,t$2,t$3,t$4,t$5,p,i;
    ...
    return SnippetsUI.docWrap(wrapper,(b=(t=(t$1=(t$2=(t$3=(t$4=(t$5=ProviderBuilder.Make().WithHole({
     $:2,
     $0:"name",
    ...
    }),t$5.WithHole(Handler.EventQ2(t$5.k,"select",function()
    {
     return t$5.i;
    },function()
    {
    ...
    }),t$4.WithHole(Handler.EventQ2(t$4.k,"togglepred",function()
    {
     return t$4.i;
    },function()
    {
     ...
     preds.Set((x=preds.Get(),(((v$1=snp.Get().snpId,preds.Get().Contains(v$1))?function(v$2)
     {
      return function(s)
      {
       return s.Remove(v$2);
    ...
    }))),(p=Handler.CompleteHoles(b.k,b.h,[]),(i=new TemplateInstance.New(p[1],SnippetsUI_Templates.snippet(p[0])),(b.i=i,i)))).get_Doc());
   };
  };
 };
 ...
 SC$1.$cctor=function()
 {
  ...
  SC$1.getPresencesW=(b$4=View$1.get_Do(),View$1.Bind(function(a$1)
  {
   ...
   return View$1.Const(Seq$1.isEmpty(ids)?"":(x$3=Strings.concat("; ",ids),(function($1)
   {
    return function($2)
    {
  ...
  SC$1.codeRequiredW=(b$5=View$1.get_Do(),View$1.Bind(function(a$1)
  {
   ...
   {
    var s$1;
    return View$1.Const(Strings.concat("\n\n",(a$1==="--"?(s$1=List.ofArray([SnippetsUI.installPresence()]),function(s$2)
    {
     return Seq$1.append(s$1,s$2);
    }):Global.id)(Seq$1.map(function(snp)
    {
     return(((((Runtime.Curried(function($1,$2,$3,$4,$5)
     {
      return $1("#line 1 @"+Utils.prettyPrint($2)+"\n"+Utils.toSafe($3)+"\nCodePresence.add "+Utils.prettyPrint($4)+" \""+Global.String($5)+"\"");
     },5))(Global.id))(snp.snpName))(snp.snpContent))(snp.snpId))(snp.snpModified);
