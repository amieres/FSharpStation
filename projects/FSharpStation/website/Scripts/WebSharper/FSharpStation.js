(function()
{
 ...
 {
  var directs;
  directs=Arrays.ofSeq(Seq$1.filter(function(a)
  {
 ...
 Hoverable$1.Content$2789$81=Runtime.Curried3(function(e,$1,$2)
 {
  return DomUtility.RemoveClass(e.elt,"hovering");
 });
 Hoverable$1.get_Attributes$2785$69=Runtime.Curried3(function(_this,$1,$2)
 {
  return _this.hover.Set(false);
 });
 Hoverable$1.get_Attributes$2784$69=Runtime.Curried3(function(_this,$1,$2)
 {
 ...
 WcTabStrip.tabStrip$2933$64=function(i,selected)
 {
  return function()
  {
   return function()
 ...
 Monaco.render$3302$48=function(monc)
 {
 ...
 MonacoGenAdapter.generateDoc$3444$48=function(monRT,onRender,genE)
 {
  return function(elchild)
  {
   var editor,_elt;
 ...
 RenderSnippets.snippets$5070$40=function(snpId)
 {
  return function(ev)
  {
   var x;
 ...
 RenderSnippets.snippets$5069$40=function(snpId)
 {
  return function(ev)
  {
 ...
 RenderSnippets.snippets$5068$40=function(snpId)
 {
  return function(ev)
  {
 ...
 RenderSnippets.snippets$5067$40=function(snpId)
 {
  return function()
  {
 ...
 RenderSnippets.snippets$5066$40=function(snpId)
 {
  return function()
  {
 ...
 RenderSnippets.snippets$5065$40=function(snpId)
 {
  var s;
 ...
 RenderSnippets.snippets$5064$40=function(snpId)
 {
  return function()
  {
 ...
 RenderProperties.render$5109$34=function()
 {
  return function()
  {
 ...
 RenderProperties.properties$5102$33=function(i)
 {
  return function()
  {
 ...
 {
  var o,o$1,t;
  return v==="button"?button:(o=(o$1=(t=(AppFramework.splitName(new AppFramework.PlugInName({
   $:0,
 ...
 MainProgram.mainProgram=function()
 {
  ...
  AppFramework.addPlugIn(PlugIn.New(new AppFramework.PlugInName({
   $:0,
   $0:"FSharpStation"
  }),ListModel.Create(function(v$2)
  {
   return v$2.varName;
  },[AppFramework.newVar(new AppFramework.PlgElemName({
   $:0,
   $0:"fileName"
  }),LoadSave.fileName()),AppFramework.newVar(new AppFramework.PlgElemName({
   $:0,
   $0:"SnippetName"
  }),Var$1.Lens(Snippets.currentSnippetV(),function($1)
  {
   return $1.snpName;
  },function($1,$2)
  {
  ...
  },function($1,$2)
  {
   ...
   $:0,
   $0:"Output"
  }),FStation.outputMsgs()),AppFramework.newVar(new AppFramework.PlgElemName({
   $:0,
   $0:"Parser"
  }),FStation.annotationsV())]),ListModel.Create(function(w)
  {
   return w.viwName;
  },[AppFramework.newViw(new AppFramework.PlgElemName({
   $:0,
   $0:"FsCode"
  }),Snippets.FsCodeW()),AppFramework.newViw(new AppFramework.PlgElemName({
   $:0,
   $0:"SaveNeeded"
  }),Snippets.SaveAsClassW()),AppFramework.newViw(new AppFramework.PlgElemName({
   $:0,
   $0:"CurrentPath"
  }),Snippets.currentPathW()),AppFramework.newViw(new AppFramework.PlgElemName({
   $:0,
   $0:"FStationId"
  }),View$1.Const(FStation.id())),AppFramework.newViw(new AppFramework.PlgElemName({
   $:0,
   $0:"CurrentSid"
  }),View$1.Map(function(sid)
  {
   return Global.String(sid.get_Id());
  },Snippets.CurrentSnippetIdW()))]),ListModel.Create(function(w)
  {
   return w.docName;
  },[AppFramework.newDoc(new AppFramework.PlgElemName({
   $:0,
   $0:"mainDoc"
  }),Lazy.Create(MainProgram.mainDoc)),AppFramework.newDoc(new AppFramework.PlgElemName({
   $:0,
   $0:"editor"
  }),Lazy.Create(function()
  {
   ...
   $:0,
   $0:"Snippets"
  }),Lazy.Create(RenderSnippets.render)),AppFramework.newDoc(new AppFramework.PlgElemName({
   $:0,
   $0:"Properties"
  }),Lazy.Create(RenderProperties.render)),AppFramework.newDoc(new AppFramework.PlgElemName({
   $:0,
   $0:"ButtonsRight"
  }),Lazy.Create(MainProgram.buttonsRight))]),ListModel.Create(function(w)
  {
   return w.actName;
  },[AppFramework.newAct(new AppFramework.PlgElemName({
   $:0,
   $0:"AddSnippet"
  }),function()
  {
  ...
  }),function()
  {
  ...
  }),AppFramework.newActF(new AppFramework.PlgElemName({
   $:0,
   $0:"LoadFile"
  }),{
   $:1,
   ...
   $1:"path",
   $2:"value"
  })]),ListModel.Create(function(w)
  {
   return w.qryName;
  },[AppFramework.newQry(new AppFramework.PlgElemName({
   $:0,
   $0:"PropertyRA"
  ...
  View$1.Sink(function(lytO)
  {
   ...
   a=(x=lytO==null?null:($1=lytO.$0,(name=$1[0],(txt=$1[1],(LayoutEngineModule.addLayout(LayoutEngineModule.newLyt(new AppFramework.PlugInName({
    $:0,
    $0:name
   }),txt)),txt===""?null:{
    $:1,
 ...
 MainProgram.mainDoc$5873$78=Global.id;
 MainProgram.mainDoc$5864$39=function()
 {
  return function(ev)
  {
 ...
 MainProgram.mainDoc$5863$39=function()
 {
  return function(ev)
  {
   ev.Target.value="";
 ...
 MainProgram.mainDoc$5862$39=function()
 {
  return function(ev)
  {
 ...
 MainProgram.mainDoc$5861$39=function()
 {
  return function(ev)
  {
   ev.Target.value="";
 ...
 MainProgram.mainDoc$5860$39=function()
 {
  return function(ev)
  {
 ...
 MainProgram.buttonsRight$5846$74=Global.id;
 MainProgram.buttonsRight$5845$74=Global.id;
 MainProgram.buttonsRight$5844$74=Global.id;
 MainProgram.buttonsRight$5843$74=Global.id;
 MainProgram.buttonsRight$5842$74=Global.id;
 ...
 {
  var o,o$1,doc;
  o=(o$1=AppFramework.tryGetDoc(new AppFramework.PlugInName({
   $:0,
   $0:plug
  }),new AppFramework.PlgElemName({
   $:0,
   $0:name
  })),o$1==null?null:{
   $:1,
 ...
 {
  var o,o$1,act;
  o=(o$1=AppFramework.tryGetAct(new AppFramework.PlugInName({
   $:0,
   $0:plug
  }),new AppFramework.PlgElemName({
   $:0,
 ...
 {
  var o,o$1;
  o=(o$1=AppFramework.tryGetViw(new AppFramework.PlugInName({
   $:0,
   $0:plug
  }),new AppFramework.PlgElemName({
   $:0,
 ...
 {
  var o,o$1;
  o=(o$1=AppFramework.tryGetVar(new AppFramework.PlugInName({
   $:0,
   $0:plug
  }),new AppFramework.PlgElemName({
   $:0,
   ...
   switch(msg.$==1?($1=msg.$0,1):msg.$==2?($1=msg.$0,2):msg.$==8?($1=msg.$0,3):msg.$==3?($1=msg.$0,4):msg.$==4?(t=msg.$0,!Unchecked.Equals(t,null)&&t.length===2?Arrays.get(msg.$0,0)==="AddOutput"?($1=Arrays.get(msg.$0,1),5):Arrays.get(msg.$0,0)==="ExecJS"?($1=Arrays.get(msg.$0,1),6):($1=[Arrays.get(msg.$0,0),Arrays.get(msg.$0,1)],9):(t$1=msg.$0,!Unchecked.Equals(t$1,null)&&t$1.length===4?Arrays.get(msg.$0,0)==="SetProperty"?($1=[Arrays.get(msg.$0,1),Arrays.get(msg.$0,2),Arrays.get(msg.$0,3)],7):14:(t$2=msg.$0,!Unchecked.Equals(t$2,null)&&t$2.length===1?($1=Arrays.get(msg.$0,0),8):(t$3=msg.$0,!Unchecked.Equals(t$3,null)&&t$3.length===3?($1=[Arrays.get(msg.$0,0),Arrays.get(msg.$0,1),Arrays.get(msg.$0,2)],10):14)))):msg.$==6?($1=msg.$0,11):msg.$==7?($1=[msg.$1,msg.$0],12):msg.$==5?13:0)
   {
     ...
     return b.Bind(FusionAsyncM.absorbO(function()
     {
      return new ResultMessage({
       ...
       $0:(function($5)
       {
        return function($6)
        {
         return $5("Snippet not found "+FSharpStation_GeneratedPrintf.p$2($6));
        };
       }(Global.id))($1)
      });
    ...
    case 14:
     return b.Return(Hole.Hole[(function($5)
     {
      return function($6)
      {
       return $5("TODO message: "+FSharpStation_GeneratedPrintf.p$3($6));
      };
     }(Global.id))(msg)]);
   }
 ...
 Server.content$6139$54=function()
 {
 ...
 SC$1.$cctor=function()
 {
  var f,g$3,f$3,b,b$1,cache,$1,cache$1,$2,cache$2,$3,g$10,v,prior,f$4,f$5,f$6,f$7,x,$4,$5,v$1,elO,s,sQ,x$1,t,t$1,t$2,t$3,t$4,t$5,t$6,t$7,t$8,x$2,t$9,t$10,i,x$3,t$11,t$12,t$13,t$14,t$15,t$16,i$1,x$4,t$17,t$18,t$19,t$20,t$21,t$22,t$23,i$2,t$24,g$13,g$14,x$5,b$2;
  ...
  SC$1.parseDateO2=(g$3=ParseO.tryParseWith(function(a$4)
  {
   var o,m$4;
   o=0;
  ...
  SC$1.parseSingleO=ParseO.tryParseWith(function(a$4)
  {
   var o,$6;
   o=0;
   return[($6=Global.Number(a$4),Global.isNaN($6)?false:(o=$6,true)),o];
  });
  ...
  SC$1.serDate=[function(x$6)
  {
   return g$8(Global.id(x$6));
  },(f$3=function(x$6)
  {
   return g$9(Global.id(x$6));
  },function(x$6)
  {
   var l;
   l=f$3(x$6);
  ...
  function getOrAdd(p,f$10)
  {
   var o;
   o=checkO(p);
   return o==null?store(p,f$10(p)):o.$0;
  }
  $1=(cache=new Dictionary.New$5(),[[checkO,function($6)
  {
   return function($7)
   {
    return getOrAdd($6,$7);
  ...
  function getOrAdd$1(p,f$10)
  {
   var o;
   o=checkO$1(p);
   return o==null?store$1(p,f$10(p)):o.$0;
  }
  $2=(cache$1=new Dictionary.New$5(),[[checkO$1,function($6)
  {
   return function($7)
   {
  ...
  function getOrAdd$2(p,f$10)
  {
   var o;
   o=checkO$2(p);
   return o==null?store$2(p,f$10(p)):o.$0;
  }
  $3=(cache$2=new Dictionary.New$5(),[[checkO$2,function($6)
  {
   return function($7)
   {
    return getOrAdd$2($6,$7);
   };
  }],function()
  {
   cache$2.Clear();
  ...
  SC$1.getParentIdO=(g$10=(Snippets.parentCache())[1],function(p)
  {
   return(g$10(p))(Snippets.getParentIdONotMemo);
  });
  ...
  SC$1.currentSnippetW=View$1.Map((f$4=function(o)
  {
   return o==null?null:Global.id(o.$0);
  },function(x$6)
  {
  ...
  SC$1.codeSnippetW=View$1.Map((f$6=function(o)
  {
   return o==null?null:Global.id(o.$0);
  },function(x$6)
  {
   return g$12(f$6(x$6));
  }),View$1.Bind((f$7=function(o)
  {
   return o==null?null:{
    $:1,
    $0:m$2(o.$0)
  ...
  },(x=Snippets.hierarchy().get_View(),View$1.Map2(function($6,$7)
  {
   return(a($6))($7);
  },Snippets.collapsedV().get_View(),x))));
  ...
  SC$1.codeAndStartsW=($4=Snippets.codeSnippetW(),($5=Snippets.snippets().v,(((Runtime.Curried3(View$1.MapAsync2))(a$1))($4))($5)));
    ...
    function m$4(snB,a$4)
    {
     ...
     return["Snp_"+Strings.Replace(Global.String(snB.snpId.get_Id()),"-",""),Strings.concat("\n",List.ofSeq(Seq$1.delay(function()
     {
      return Seq$1.append(["editorButtons vertical 0-85-100 FStationLyt.menuEditor buttons"],Seq$1.delay(function()
      {
       ...
       {
        var x$6,x$7;
        return[(x$6=Strings.concat(" ",(x$7=List.ofSeq(Operators$5.range(0,Seq$1.length(ss)-1)),Seq$1.map(function($6)
        {
         return function($7)
         {
          return $6("btn"+Global.String($7));
         };
        }(Global.id),x$7))),(((Runtime.Curried3(function($6,$7,$8)
        {
  ...
  SC$1.serSnippetId=(s=Arrays.head(Strings.SplitChars((function($6)
  {
   return function($7)
   {
    return $6(FSharpStation_GeneratedPrintf.p($7));
   };
  ...
  },t$10[0],t$10[1]))],(i=SnippetModule.New("","",null),[function(dim)
  {
   ...
   function c(n,ser,_deser)
   {
    ...
    return x$7==null?null:{
     $:1,
     $0:m$4(x$7.$0)
    };
   }
   x$6=Strings.concat(", ",Seq$1.choose(function($6)
   {
    return c($6[0],$6[1],$6[2]);
   },x$1));
   return(function($6)
   {
    return function($7)
  ...
  SC$1.serModel=(x$3=[(t$11=(t$12=Serializer$1.serSnippet(),Serializer.serArr(t$12[0],t$12[1])),Serializer.serField("snippets",function(m$4)
  {
   return m$4.snippets;
  },function(v$2,m$4)
  {
  ...
  SC$1.serSnippet2=(x$4=[(t$17=Importer.serSnippetId2(),Serializer.serField("id",function(s$1)
  {
   return s$1.snpId;
  },function(v$2,s$1)
  {
  ...
  SC$1.FStationLyt=new AppFramework.PlugInName({
   $:0,
   $0:"FStationLyt"
  });
  ...
  Concurrency.Start((b$2=null,Concurrency.Delay(function()
  {
   return Concurrency.Bind(Concurrency.Sleep(1000),function()
   {
    ...
    },Concurrency.Delay(function()
    {
     return Concurrency.TryWith(Concurrency.Delay(function()
     {
      var _this,f$10,g$15,f$11,dst,p;
      function f$12(a$4)
      {
      ...
      _this.payloadProcessorO={
       ...
       $0:(f$10=function(x$6)
       {
        return Messaging.processMessage(f$12(x$6));
       },(g$15=(f$11=function(x$6)
       {
        return g$16(f$13(x$6));
       },function(v$2)
       {
        return Concurrency.Bind(v$2,f$11);
       }),function(x$6)
       {
        return g$15(f$10(x$6));
       }))
