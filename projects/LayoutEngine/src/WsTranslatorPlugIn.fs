#nowarn "3242"
////-d:DLL -d:FSharpStation1612884909147 -d:TEE -d:WEBSHARPER -d:WEBSHARPER47
    ...
    open WebSharper
        ...
        module LibraryJS =
            ...
            module WsTranslatorLoader =
                ...
                type WasmPath = WasmPath of string member this.Id = let (WasmPath v) = this in v
                    ...
                    let loadInThisThread (publishPath:WasmPath) debug opts =
                        ...
                        Async.FromContinuations(fun (ok, ko, ca) ->
                            ...
                            async {
                                ...
                                //                    "init", init
                                //                ]
                                let! v = requireJsA [| publishPath.Id + "mono-config.js" |]
                                //let! v = requireJsA [| publishPath.Id + "runtime.js" |]
                                ...
                                let! v = requireJsA [| publishPath.Id + "dotnet.js" |]
                                ()
                            } |> Async.Start
                        ) |> Async.Start
