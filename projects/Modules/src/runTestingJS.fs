...
#nowarn "52"
#nowarn "1178"
////-d:FSharpStation1612744711896 -d:TEE -d:WEBSHARPER
...
//#define FSharpStation1612744711896
#if !NOFSROOT
#if INTERACTIVE
module FsRoot   =
#else
...
namespace FsRoot
    ...
    open WebSharper
        ...
        module Library2 =
            ...
            module FSharpStationClient =
                ...
                let mutable fsharpStationAddress = Address "FSharpStation1612744711896"
    ...
    module RunTestingJs =
        ...
        let run () = fusion {
            ...
            let  modif    = testLoadFile() |>! print |> File.GetLastWriteTime
