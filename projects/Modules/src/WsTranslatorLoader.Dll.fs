...
#nowarn "3180"
#nowarn "52"
////-d:FSharpStation1593197096670 -d:TEE -d:WEBSHARPER -d:WsTranslatorWASM
...
namespace FsRoot
    ...
    open WebSharper
        ...
        module Library2 =
            ...
            module WebSockets =
                ...
                #else
                    "http://localhost:9005/#/Snippet/4ea26c50-c193-445f-828d-fccd1c1df79a"
                #endif
    ...
    module WsCompileDll =
        ...
        let compileWASMLoader show snp =
            fusion {
                FSharpStationClient.fsharpStationAddress <- WebSockets.Address "FSharpStation1593197096670"
                let! _         = compileSnippetRm show snp
                let! out       = ofFusionM <| getValueRm FsCode.fscOutput
                let! name      = ofFusionM <| getValueRm FsCode.intName
                let  path      = "D:\Abe\CIPHERWorkspace\FSharpStation/website/"
        
                let fixJs name (txt:string) = txt.Replace(sprintf ".ScriptPath(%A," name, sprintf ".ScriptPath(\"..%s\"," WASMDir )        
                let asm        = sprintf @"D:\Abe\CIPHERWorkspace\FSharpStation\website\EPFileX\Assemblies\%s.asm" name
        ...
        // FsRoot.WsCompileDll.processAsm id @"D:\Abe\CIPHERWorkspace\FSharpStation\projects/FSharpStation/bin/FSharpStation.exe" @"D:\Abe\CIPHERWorkspace\FSharpStation\website\EPFileX\Assemblies\FSharpStation.asm"
        // FsRoot.WsCompileDll.processAsm id @"D:\Abe\CIPHERWorkspace\FSharpStation\projects/LayoutEngine/bin/MonacoPlugIn.dll" @"D:\Abe\CIPHERWorkspace\FSharpStation\website\EPFileX\Assemblies\MonacoPlugIn.asm"
        
        // FsRoot.WsCompileDll.processAsm id @"D:\Abe\CIPHERWorkspace\FSharpStation\projects/LayoutEngine/bin/LayoutEngine.dll" @"D:\Abe\CIPHERWorkspace\FSharpStation\website\EPFileX\Assemblies\LayoutEngine.asm"
