...
#nowarn "1182"
#nowarn "1178"
////-d:FSharpStation1560915624558 -d:NETSTANDARD20 -d:NOFRAMEWORK --noframework -d:TEE -d:WEBSHARPER
...
//#define FSharpStation1560915624558
#if INTERACTIVE
module FsRoot   =
#else
namespace FsRoot
    ...
    module ProzperServer =
        ...
        module Rpc =
            ...
            let [< Rpc >] borrarFormaPago          aid    p      : AR<_> =                  borrarFormaPago0         aid     p      |> AzureHandler.run// |> Async.rtn
