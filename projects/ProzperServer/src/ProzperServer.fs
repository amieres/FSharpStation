...
#nowarn "1182"
#nowarn "1178"
////-d:FSharpStation1559673172621 -d:NETSTANDARD20 -d:NOFRAMEWORK --noframework -d:TEE -d:WEBSHARPER
    ...
    module ProzperServer =
        ...
        module Eventos =
            ...
            let manejadorGenerico (msg:ObjetoDatos<obj>) : ResultadoManejador<_> =
                ...
                | false, _         -> failwithf "No Handler for message: %A %s" msg (Manejadores.Keys |> Seq.map (sprintf "%A") |> String.concat "\n")
        ...
        module ClientSide =
            ...
            //                                            ,  storeAuthStateInCookie    = false ))
                ...
                let getTokenO0() = async {
                    ...
                    | Some user  -> let! auth = agent.Value.acquireTokenSilent(authParms () ) |> Promise.AsAsync 
            ...
            module ModeloUI =
                ...
                module FormaFirma =
                    ...
                    let subirScreenShot filenamePre = async {
                    ...
                    let formaFirma (nombre:View<string>) (contenido:Doc) procesar filenamePre =
                        let firmarDocumento() = 
                            asyncResult {
                                if mensajes.Value <> "" then JS.Alert mensajes.Value else
                                do! subirScreenShot filenamePre
                    ...
                    let formaAutorizacion () =
                        let formaContenido  =
                            TemplateLib.AutorizacionPago()
                                ...
                                .Doc()
                        FormaFirma.formaFirma titular.View formaContenido actualizarSubscripcion "AutorizacionPago"
                    ...
                    let formaContrato () =
                        ...
                        let formaContenido  =
                            TemplateLib.Contrato()
                                .Aliado( nombreW.V ) 
                                .Doc()
                        FormaFirma.formaFirma nombreW formaContenido firmarContrato "Contrato"
                ...
                module Transacciones =
                    ...
                    let transaccionesW = 
                        ...
                        |> View.MapAsync (fun modelo -> 
                            Rpc.obtenerTransaccionesPara modelo.idAliado 
                    ...
                    let docTransacciones aliadoW =
                        TemplateLib.Transacciones()
                            .TBody(
                                ...
                                ||> View.Map2 (fun trs al -> trs |> Seq.filter (fun tr -> tr.idAliado = al.id) )
