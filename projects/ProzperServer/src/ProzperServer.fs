...
#nowarn "1182"
#nowarn "1178"
////-d:FSharpStation1559673172621 -d:NETSTANDARD20 -d:NOFRAMEWORK --noframework -d:WEBSHARPER
                ...
                module FormaFirma =
                    ...
                    let subirScreenShot filenamePre = async {
                        ...
                        canvas?toBlob (fun (blob:Blob) ->
                            let filename = sprintf "%s %s.png" filenamePre <| nowStamp().Replace(":",".")
                            let fd = FormData()
