...
(function()
{
 ...
 prozperProd$js_Templates=Global.prozperProd$js_Templates=Global.prozperProd$js_Templates||{};
 prozperProd$js_GeneratedPrintf=Global.prozperProd$js_GeneratedPrintf=Global.prozperProd$js_GeneratedPrintf||{};
 prozperProd$js_Router=Global.prozperProd$js_Router=Global.prozperProd$js_Router||{};
 Doc=UI.Doc=UI.Doc||{};
 ...
 SC$1=Global.StartupCode$prozperProd_js$prozperProd_js=Global.StartupCode$prozperProd_js$prozperProd_js||{};
 ...
 SC$11=Global.StartupCode$WebSharper_UI$Doc_Proxy=Global.StartupCode$WebSharper_UI$Doc_Proxy||{};
 ...
 MainProgram.mainProgram=function()
 {
  ...
  {
   var b$1,p$1,i;
   return Unchecked.Equals(al.id,Aliado$2.empty().id)?(b$1=ProviderBuilder.Make(),(p$1=Handler.CompleteHoles(b$1.k,b$1.h,[]),(i=new TemplateInstance.New(p$1[1],prozperProd$js_Templates.opcionesadministrador(p$1[0])),(b$1.i=i,i)))).get_Doc():Doc.get_Empty();
  },ModeloUI.aliadoW());
 ...
 RenderAliados.aliados=function()
 {
  ...
  function a(alid,alv)
  {
   ...
   {
    seleccionar(alid);
   }))),(p$1=Handler.CompleteHoles(b$1.k,b$1.h,[]),(i$1=new TemplateInstance.New(p$1[1],prozperProd$js_Templates.filaaliado(p$1[0])),(b$1.i=i$1,i$1)))).get_Doc();
  }
  ...
  },ModeloUI.modeloV().get_View()),View.Map2(function(a$1,a$2)
  {
   ...
   $0:"tbody",
   $1:T$2
  })),(p=Handler.CompleteHoles(b.k,b.h,[]),(i=new TemplateInstance.New(p[1],prozperProd$js_Templates.tablaaliados(p[0])),(b.i=i,i)))).get_Doc();
 };
 RenderAliado.aliado=function()
 {
  ...
  return ModeloUI.selAliadoIdDoc(function(alv)
  {
   ...
   return(b=(C=RenderAliado.calculo(),ProviderBuilder.Make().WithHole({
    ...
    $0:"calculo",
    $1:C
   })),(p=Handler.CompleteHoles(b.k,b.h,[]),(i=new TemplateInstance.New(p[1],prozperProd$js_Templates.aliado(p[0])),(b.i=i,i)))).get_Doc();
  });
 };
 RenderAliado.calculo=function()
 {
  ...
  return ModeloUI.selAliadoIdDoc(function(alv)
  {
   ...
   }),(p=Handler.CompleteHoles(b.k,b.h,[]),(i=new TemplateInstance.New(p[1],prozperProd$js_Templates.calculo(p[0])),(b.i=i,i)))).get_Doc();
  });
 };
   ...
   Strings.Trim(m)!==""?Global.alert(m):($1=datosOV.Get(),$2=correoOV.Get(),$3=telefonoOV.Get(),$4=direccionOV.Get(),$1!=null&&$1.$==1&&($2!=null&&$2.$==1&&($3!=null&&$3.$==1&&($4!=null&&$4.$==1&&($5=[$2.$0,$1.$0,$4.$0,$3.$0],true))))?(correo=$5[0],datos=$5[1],direccion=$5[2],telefono=$5[3],Rpc.iterA((b$1=Monads.asyncResult(),b$1.Run(b$1.Delay(function()
   {
    ...
    }),function(a)
    {
     ...
     Global.alert((function($6)
     {
      return function($7)
      {
       return $6(prozperProd$js_GeneratedPrintf.p$3($7));
      };
     }(Global.id))(a));
     return b$1.Zero();
    });
   }))))):Global.alert("Error not caught FormaRegistro"));
  }))),(p$4=Handler.CompleteHoles(b.k,b.h,[]),(i=new TemplateInstance.New(p$4[1],prozperProd$js_Templates.formaregistro(p$4[0])),(b.i=i,i))));
   ...
   Strings.Trim(m)!==""?Global.alert(m):($1=datosOV.Get(),$2=View.TryGet(aliadoW),$1!=null&&$1.$==1&&($2!=null&&$2.$==1&&($3=[$2.$0,$1.$0],true))?(al=$3[0],datos=$3[1],Rpc.iterA((b$1=Monads.asyncResult(),b$1.Run(b$1.Delay(function()
   {
    ...
    }),function(a)
    {
     ...
     Global.alert((function($4)
     {
      return function($5)
      {
       return $4(prozperProd$js_GeneratedPrintf.p$3($5));
      };
     }(Global.id))(a));
     return b$1.Zero();
    });
   }))))):Global.alert("Error not caught FormaDatos"));
  }))),(p$1=Handler.CompleteHoles(b.k,b.h,[]),(i=new TemplateInstance.New(p$1[1],prozperProd$js_Templates.formadatospersonales(p$1[0])),(b.i=i,i))));
  View.Sink(function(a)
  {
   mensajes.Set(a);
  },View.Map(function($1)
   ...
   Strings.Trim(m)!==""?Global.alert(m):(m$1=View.TryGet(aliadoW),m$1!=null&&m$1.$==1?(al=m$1.$0,Rpc.iterA((b$1=Monads.asyncResult(),b$1.Run(b$1.Delay(function()
   {
    ...
    }),function(a)
    {
     ...
     Global.alert((function($1)
     {
      return function($2)
      {
       return $1(prozperProd$js_GeneratedPrintf.p$3($2));
      };
     }(Global.id))(a));
     return b$1.Zero();
    });
   }))))):Global.alert("Error not caught FormaDatos"));
  }))),(p=Handler.CompleteHoles(b.k,b.h,[]),(i=new TemplateInstance.New(p[1],prozperProd$js_Templates.formacontactos(p[0])),(b.i=i,i)))).get_Doc();
 };
 ...
 FormaFormasPago.formaFormasPago=function(aliadoW)
 {
  ...
  function otherButtons(i$1,docF)
  {
   ...
   {
    return Seq.append([Doc.Button("AUTORIZAR DEBITO",[AttrProxy.Create("class","mui-btn mui-btn--raised mui-btn--primary"),AttrProxy.Create("title","Autorizar pago recurrente"),AttrModule.Dynamic("style",View.Map(function($1)
    {
    ...
    })],Seq.delay(function()
    {
     return Seq.append([Doc.Element("br",[],[])],Seq.delay(function()
     {
      return Seq.append([Doc.Element("br",[],[])],Seq.delay(function()
      {
       ...
       {
        return Seq.append([Doc.BindView(Global.id,View.Map(function($1)
        {
         var m;
        ...
        },formasPagoV.get_View()))],Seq.delay(function()
        {
  ...
  }))),(p=Handler.CompleteHoles(b.k,b.h,[]),(i=new TemplateInstance.New(p[1],prozperProd$js_Templates.formacuentas(p[0])),(b.i=i,i)))).get_Doc();
 };
 FormaFormasPago.msg=function(a)
 {
  ...
  return idR.$==0?(function($1)
  {
   return function($2)
   {
    return $1("Cuenta verificada: "+prozperProd$js_GeneratedPrintf.p$4($2));
   };
 ...
 {
  var aliadosV,ordenV,filtroV,referidores,pendientes,b,listaArchivos,b$1,T$2,t,t$1,t$2,t$3,t$4,t$5,t$6,t$7,t$8,t$9,t$10,t$11,t$12,t$13,t$14,p,i;
  ...
  function a(alid,fW)
  {
   ...
   }),(p$1=Handler.CompleteHoles(b$2.k,b$2.h,[["status",0],["influyente",0],["referido",0]]),(i$2=new TemplateInstance.New(p$1[1],prozperProd$js_Templates.filaconsolidado(p$1[0])),(b$2.i=i$2,i$2)))).get_Doc();
  }
  ...
  ordenV=Var$1.Create$1(Arrays.mapi(function(i$1,t$15)
  {
  ...
  return(b$1=(T$2=Doc.ConvertSeqBy(function(al)
  {
  ...
  },function()
  {
   ...
   $0:"tbody",
   $1:T$2
  })),(p=Handler.CompleteHoles(b$1.k,b$1.h,[["filtro",0]]),(i=new TemplateInstance.New(p[1],prozperProd$js_Templates.consolidado(p[0])),(b$1.i=i,i)))).get_Doc();
 };
 ...
 TablaPagos.comisiones=function()
 {
  ...
  function a$1(alid,alfpW)
  {
   ...
   }),(p$3=Handler.CompleteHoles(b$3.k,b$3.h,[]),(i$3=new TemplateInstance.New(p$3[1],prozperProd$js_Templates.filapago(p$3[0])),(b$3.i=i$3,i$3)))).get_Doc();
  }
  ...
  return(b=(T$2=List.ofArray([(b$1=ProviderBuilder.Make().WithHole({
   ...
   $0:"nombre",
   $1:""
  }),(p=Handler.CompleteHoles(b$1.k,b$1.h,[]),(i=new TemplateInstance.New(p[1],prozperProd$js_Templates.filapago(p[0])),(b$1.i=i,i)))).get_Doc(),(b$2=ProviderBuilder.Make().WithHole({
   $:1,
   $0:"codigo",
   $1:""
  }).WithHole({
   ...
   $0:"nombre",
   $1:""
  }),(p$1=Handler.CompleteHoles(b$2.k,b$2.h,[]),(i$1=new TemplateInstance.New(p$1[1],prozperProd$js_Templates.filapago(p$1[0])),(b$2.i=i$1,i$1)))).get_Doc(),Doc.ConvertSeqBy(function($1)
  {
   return a($1[0],$1[1]);
  },function($1)
  {
  ...
  },function()
  {
   ...
   $0:"tbody",
   $1:Doc.Concat(T$2)
  })),(p$2=Handler.CompleteHoles(b.k,b.h,[]),(i$2=new TemplateInstance.New(p$2[1],prozperProd$js_Templates.tablapagos(p$2[0])),(b.i=i$2,i$2)))).get_Doc();
 };
 ListaDocs.listaDocs=function()
 {
  ...
  return(b=(t=(T$2=Doc.EmbedView(View.Map(VariousUI.crearOptions,VariousUI.tiposAr().get_View())),(t$1=(T$3=ListModel$1.docLensMapView(Global.id,function(nm,arV)
  {
   ...
   }),(p$1=Handler.CompleteHoles(b$1.k,b$1.h,[]),(i$2=new TemplateInstance.New(p$1[1],prozperProd$js_Templates.enlacedocumento(p$1[0])),(b$1.i=i$2,i$2)))).get_Doc();
   ...
   }),function(x)
   {
    ...
    $0:"disabled",
    $1:d
   })),(p$2=Handler.CompleteHoles(b$2.k,b$2.h,[["tipo",0],["status",0]]),(i$3=new TemplateInstance.New(p$2[1],prozperProd$js_Templates.filadocs(p$2[0])),(b$2.i=i$3,i$3)))).get_Doc();
  ...
  }))),(p=Handler.CompleteHoles(b.k,b.h,[]),(i=new TemplateInstance.New(p[1],prozperProd$js_Templates.subirdocumentos(p[0])),(b.i=i,i)))).get_Doc();
 };
 ...
 FormaAutorizacion.formaAutorizacion=function()
 {
  ...
  formaContenido=(b=(C=Doc.EmbedView(FormaAutorizacion.cuentaAutorizar().get_View()),ProviderBuilder.Make().WithHole({
   ...
   $0:"cuentadebitar",
   $1:C
  })),(p=Handler.CompleteHoles(b.k,b.h,[]),(i=new TemplateInstance.New(p[1],prozperProd$js_Templates.autorizacionpago(p[0])),(b.i=i,i)))).get_Doc();
 ...
 FormaContrato.formaContrato=function()
 {
  ...
  return FormaFirma.formaFirma(nombreW,(b=ProviderBuilder.Make().WithHole({
   ...
   $0:"aliado",
   $1:nombreW
  }),(p=Handler.CompleteHoles(b.k,b.h,[]),(i=new TemplateInstance.New(p[1],prozperProd$js_Templates.contrato(p[0])),(b.i=i,i)))).get_Doc(),TipoArchivo.Contrato,FormaContrato.firmarContrato,"Contrato");
 };
 ...
 Transacciones.docTransacciones=function(aliadoW)
 {
  ...
  function a(trid,trv)
  {
   ...
   }),(p$1=Handler.CompleteHoles(b$1.k,b$1.h,[]),(i$1=new TemplateInstance.New(p$1[1],prozperProd$js_Templates.transaccion(p$1[0])),(b$1.i=i$1,i$1)))).get_Doc();
  }
  function a$1(trs,al)
  {
  ...
  },function($1)
  {
   ...
   $0:"tbody",
   $1:T$2
  })),(p=Handler.CompleteHoles(b.k,b.h,[]),(i=new TemplateInstance.New(p[1],prozperProd$js_Templates.transacciones(p[0])),(b.i=i,i)))).get_Doc();
 };
 ...
 Pendientes.pendientes=function(aliadoW)
 {
  return Doc.BindView(Global.id,View.MapAsync(function(al)
  {
   ...
   return Concurrency.Delay(function()
   {
    ...
    {
     var $1,b$1,p,p$1,i;
     return a.$==0&&Seq.isEmpty(a.$0)?Concurrency.Return(Doc.get_Empty()):a.$==1?Concurrency.Return(Doc.TextNode(a.$0)):Concurrency.Return((b$1=(p=Doc.Concat(Seq.map(Pendientes.pendiente,a.$0)),ProviderBuilder.Make().WithHole({
      $:0,
      $0:"pasos",
      $1:p
     })),(p$1=Handler.CompleteHoles(b$1.k,b$1.h,[]),(i=new TemplateInstance.New(p$1[1],prozperProd$js_Templates.pendientes(p$1[0])),(b$1.i=i,i)))).get_Doc());
    });
   });
  },aliadoW));
 };
  ...
  return b.Run(b.Delay(function()
  {
   return aliado.status.$==0?b.Bind$1(archivosAR,function(a)
   {
    return b.Bind$1(cuentasAR,function(a$1)
    {
     ...
     return b.Return(List.ofSeq(Seq.delay(function()
     {
      var t;
 ...
 Pendientes.chequearArchivos=function(es,subirlo,archivos)
 {
  ...
  return!Unchecked.Equals(m,null)&&m.length===0?[subirlo()]:(m$1=Seq.tryFind(function(d)
  {
   return d.status.$===1;
  },m),m$1==null?(mensajes=Seq.map(Pendientes.verificarArchivo,m),Seq.exists(function(d)
  {
   return d.status.$!==2;
  },m)?mensajes:Seq.append(mensajes,[subirlo()])):[Pendientes.verificarArchivo(m$1.$0)]);
 };
 ...
 Pendientes.chequearCuentas=function(es,agregar,cuentas)
 {
  ...
  return!Unchecked.Equals(m,null)&&m.length===0?[agregar()]:Seq.map(Pendientes.verificarCuenta,m);
 };
 ...
 Pendientes.verificarCuenta=function(fp)
 {
  ...
  m=fp.authorizeIdR;
  return m.$==1?List.ofArray([Doc.Element("i",[AttrProxy.Create("class","far fa-square")],[]),Doc.TextNode(((((Runtime$1.Curried(function($1,$2,$3,$4)
  {
   return $1(" "+Utils.toSafe($2)+" "+Utils.toSafe($3)+" NO REGISTRADA en Authorize ("+Utils.toSafe($4)+")");
  },4))(Global.id))(fp.cuentaPago.get_TipoLargo()))(fp.cuentaPago.get_MaskedCuenta()))(m.$0))]):List.ofArray([Doc.Element("i",[AttrProxy.Create("class","far fa-check-square")],[]),Doc.TextNode((((((Runtime$1.Curried(function($1,$2,$3,$4,$5)
  {
 ...
 Pendientes.enlaceArchivo=function(ar)
 {
  ...
  return(b=(n=(Pendientes.tarchivo2String(ar.tipo))[0][0],ProviderBuilder.Make().WithHole({
   ...
   $0:"nombre",
   $1:n
  })),(p=Handler.CompleteHoles(b.k,b.h,[]),(i=new TemplateInstance.New(p[1],prozperProd$js_Templates.enlacedocumento(p[0])),(b.i=i,i)))).get_Doc();
 };
 ...
 prozperProd$js_Templates.opcionesadministrador=function(h)
 {
 ...
 prozperProd$js_Templates.filaaliado=function(h)
 {
  Templates.LoadLocalTemplates("indexdes");
  return h?Templates.NamedTemplate("indexdes",{
   $:1,
 ...
 prozperProd$js_Templates.tablaaliados=function(h)
 {
  Templates.LoadLocalTemplates("indexdes");
  return h?Templates.NamedTemplate("indexdes",{
   $:1,
 ...
 prozperProd$js_Templates.aliado=function(h)
 {
  Templates.LoadLocalTemplates("indexdes");
  return h?Templates.NamedTemplate("indexdes",{
   $:1,
 ...
 prozperProd$js_Templates.calculo=function(h)
 {
  Templates.LoadLocalTemplates("indexdes");
  return h?Templates.NamedTemplate("indexdes",{
   $:1,
 ...
 prozperProd$js_GeneratedPrintf.p$3=function($1)
 {
  return $1.$==2?"Mensaje "+Utils.prettyPrint($1.$0):$1.$==1?"NuevoRegistro "+Utils.prettyPrint($1.$0):"ROk";
 };
 prozperProd$js_Templates.formaregistro=function(h)
 {
  Templates.LoadLocalTemplates("indexdes");
  return h?Templates.NamedTemplate("indexdes",{
   $:1,
 ...
 prozperProd$js_Templates.filaconsolidado=function(h)
 {
  Templates.LoadLocalTemplates("indexdes");
  return h?Templates.NamedTemplate("indexdes",{
   $:1,
 ...
 prozperProd$js_Templates.consolidado=function(h)
 {
  Templates.LoadLocalTemplates("indexdes");
  return h?Templates.NamedTemplate("indexdes",{
   $:1,
 ...
 prozperProd$js_Templates.filapago=function(h)
 {
  Templates.LoadLocalTemplates("indexdes");
  return h?Templates.NamedTemplate("indexdes",{
   $:1,
 ...
 prozperProd$js_Templates.tablapagos=function(h)
 {
  Templates.LoadLocalTemplates("indexdes");
  return h?Templates.NamedTemplate("indexdes",{
   $:1,
 ...
 prozperProd$js_Templates.filadocs=function(h)
 {
  Templates.LoadLocalTemplates("indexdes");
  return h?Templates.NamedTemplate("indexdes",{
   $:1,
 ...
 prozperProd$js_Templates.enlacedocumento=function(h)
 {
  Templates.LoadLocalTemplates("indexdes");
  return h?Templates.NamedTemplate("indexdes",{
   $:1,
 ...
 prozperProd$js_Templates.subirdocumentos=function(h)
 {
  Templates.LoadLocalTemplates("indexdes");
  return h?Templates.NamedTemplate("indexdes",{
   $:1,
 ...
 prozperProd$js_Templates.autorizacionpago=function(h)
 {
  Templates.LoadLocalTemplates("indexdes");
  return h?Templates.NamedTemplate("indexdes",{
   $:1,
 ...
 prozperProd$js_Templates.contrato=function(h)
 {
  Templates.LoadLocalTemplates("indexdes");
  return h?Templates.NamedTemplate("indexdes",{
   $:1,
 ...
 prozperProd$js_Templates.pendientes=function(h)
 {
  Templates.LoadLocalTemplates("indexdes");
  return h?Templates.NamedTemplate("indexdes",{
   $:1,
 ...
 prozperProd$js_Router.r=function()
 {
 ...
 prozperProd$js_GeneratedPrintf.p=function($1)
 {
  return $1.$==5?"Dia25":$1.$==4?"Dia20":$1.$==3?"Dia15":$1.$==2?"Dia10":$1.$==1?"Dia05":"Dia01";
 };
 prozperProd$js_Templates.datospersonales=function(h)
 {
  Templates.LoadLocalTemplates("indexdes");
  return h?Templates.NamedTemplate("indexdes",{
   $:1,
 ...
 prozperProd$js_GeneratedPrintf.p$2=function($1)
 {
  return $1.$==2?"Empresa":$1.$==1?"Femenino":"Masculino";
 };
 prozperProd$js_Templates.correo=function(h)
 {
  Templates.LoadLocalTemplates("indexdes");
  return h?Templates.NamedTemplate("indexdes",{
   $:1,
 ...
 prozperProd$js_Templates.telefono=function(h)
 {
  Templates.LoadLocalTemplates("indexdes");
  return h?Templates.NamedTemplate("indexdes",{
   $:1,
 ...
 prozperProd$js_Templates.direccion=function(h)
 {
  Templates.LoadLocalTemplates("indexdes");
  return h?Templates.NamedTemplate("indexdes",{
   $:1,
 ...
 prozperProd$js_Templates.formadatospersonales=function(h)
 {
  Templates.LoadLocalTemplates("indexdes");
  return h?Templates.NamedTemplate("indexdes",{
   $:1,
 ...
 prozperProd$js_Templates.formacontactos=function(h)
 {
  Templates.LoadLocalTemplates("indexdes");
  return h?Templates.NamedTemplate("indexdes",{
   $:1,
 ...
 prozperProd$js_Templates.formacuentas=function(h)
 {
  Templates.LoadLocalTemplates("indexdes");
  return h?Templates.NamedTemplate("indexdes",{
   $:1,
 ...
 prozperProd$js_Templates.formafirma=function(h)
 {
  Templates.LoadLocalTemplates("indexdes");
  return h?Templates.NamedTemplate("indexdes",{
   $:1,
 ...
 prozperProd$js_Templates.transaccion=function(h)
 {
  Templates.LoadLocalTemplates("indexdes");
  return h?Templates.NamedTemplate("indexdes",{
   $:1,
 ...
 prozperProd$js_Templates.transacciones=function(h)
 {
  Templates.LoadLocalTemplates("indexdes");
  return h?Templates.NamedTemplate("indexdes",{
   $:1,
 ...
 prozperProd$js_GeneratedPrintf.p$4=function($1)
 {
  return"IdPayment "+Utils.prettyPrint($1.$0);
 };
 prozperProd$js_Templates.cuentabancaria=function(h)
 {
  Templates.LoadLocalTemplates("indexdes");
  return h?Templates.NamedTemplate("indexdes",{
   $:1,
 ...
 prozperProd$js_Templates.tarjetacredito=function(h)
 {
  Templates.LoadLocalTemplates("indexdes");
  return h?Templates.NamedTemplate("indexdes",{
   $:1,
 ...
 prozperProd$js_GeneratedPrintf.p$1=function($1)
 {
  ...
  return b.Run(b.Delay(function()
  {
   return b.TryFinally(b.Delay(function()
   {
    return Extensions["AsyncResultBuilder.Bind"](b,(Rpc.addLlamadas())(1),function()
    {
     ...
     },Concurrency.Bind((Msal.getTokenO())(),function(x)
     {
 ...
 SC$1.$cctor=function()
 {
  ...
  m==="InPreamble"||(m===""||m===null)?Msal.storeValue("preambleState","GoToSignIn"):void 0;
  ...
  {
   return Seq.distinct(f$4(x));
  },function(x)
  {
   return Seq.sort(f$3(x));
  }),function(x)
  {
   return g$3(f$2(x));
  ...
  SC$1.endPointV=Router.InstallHash(EndPoint.DefaultEP,prozperProd$js_Router.r());
  View.Sink(function(a)
  {
   if(a.$==1)
    ;
  ...
  {
   var $3,$4;
   return a$1.$==0&&!Unchecked.Equals(Msal.userO().Get(),null)?"ProzperLyt.mainContent":a$1.$==3&&(!Unchecked.Equals(Msal.userO().Get(),null)&&($4=a$1.$0,true))?$4:a$1.$==2?"ProzperLyt.cntPreRegister":a$1.$==4?"ProzperLyt.cntPDF":a$1.$==5?"ProzperLyt.cntVideo":"ProzperLyt.cntFormaNoUser";
  ...
  $2=(llamadas=Var$1.Create$1(0),[llamadas.get_View(),function(n)
  {
   var b$4;
   b$4=null;
   return Concurrency.Delay(function()
  ...
  SC$1.firmadoV=Var$1.Create$1(false);
  Concurrency.Start((b$3=null,Concurrency.Delay(function()
  {
   return Concurrency.While(function()
   {
  ...
  SC$1.cuentaPagoO=Var$1.Create$1(null);
  ...
  SC$1.i_archivos=ReporteConsolidado.agregarCampo(1,false,function(al)
  {
   ...
   }(Global.id))(al.documentos):(((Runtime$1.Curried3(function($3,$4,$5)
   {
  ...
  SC$1.i_correo=ReporteConsolidado.agregarCampo(13,true,Aliado$2.correo);
  ...
  SC$1.i_diaPago=ReporteConsolidado.agregarCampo(10,true,function(al)
  {
   return Library["String.Right$1"]((function($3)
   {
    return function($4)
    {
     return $3(prozperProd$js_GeneratedPrintf.p($4));
    };
 ...
 DatosPersonales.formaDoc=function(datosV)
 {
  ...
  forma=(b=(G=Doc.EmbedView(View.Map(VariousUI.crearOptions,VariousUI.generos().get_View())),ProviderBuilder.Make().WithHole({
   ...
   $0:"generos",
   $1:G
  })),(p=Handler.CompleteHoles(b.k,b.h,[["nombres",0],["apellidos",0],["fechanacimiento",0],["genero",0]]),(i=new TemplateInstance.New(p[1],prozperProd$js_Templates.datospersonales(p[0])),(b.i=i,i))));
  View.Sink(function(a)
  {
   var dat;
   if(a!=null&&a.$==1)
    {
     ...
     forma.Hole("genero").Set((function($1)
     {
      return function($2)
      {
       return $1(prozperProd$js_GeneratedPrintf.p$2($2));
      };
 ...
 CorreoElectronico$1.formaDoc=function(corV)
 {
  ...
  forma=(b=ProviderBuilder.Make().WithHole({
   ...
   $0:"mensaje",
   $1:mensaje.get_View()
  }),(p=Handler.CompleteHoles(b.k,b.h,[["correo",0],["confirmarcorreo",0]]),(i=new TemplateInstance.New(p[1],prozperProd$js_Templates.correo(p[0])),(b.i=i,i))));
  m=corV.Get();
 ...
 Telefono.formaDoc=function(telOV)
 {
  ...
  forma=(b=(T$2=Doc.EmbedView(View.Map(VariousUI.crearOptions,VariousUI.tiposTel().get_View())),ProviderBuilder.Make().WithHole({
   ...
   $0:"tipos",
   $1:T$2
  })),(p=Handler.CompleteHoles(b.k,b.h,[["tipotelefono",0],["codigopais",0],["codigoarea",0],["telefono",0],["extension",0]]),(i=new TemplateInstance.New(p[1],prozperProd$js_Templates.telefono(p[0])),(b.i=i,i))));
  View.Sink(function(a)
  {
   var tel;
   if(a!=null&&a.$==1)
 ...
 Direccion.formaDoc=function(dirV)
 {
  ...
  forma=(b=(T$2=Doc.EmbedView(View.Map(VariousUI.crearOptions,VariousUI.tiposDir().get_View())),(E=Doc.EmbedView(View.Map(VariousUI.crearOptions,VariousUI.estados().get_View())),(P=Doc.EmbedView(View.Map(VariousUI.crearOptions,VariousUI.paises().get_View())),ProviderBuilder.Make().WithHole({
   ...
   $0:"tipos",
   $1:T$2
  })),(p=Handler.CompleteHoles(b.k,b.h,[["tipodireccion",0],["direccion1",0],["direccion2",0],["ciudad",0],["estado",0],["codigopostal",0],["pais",0]]),(i=new TemplateInstance.New(p[1],prozperProd$js_Templates.direccion(p[0])),(b.i=i,i))));
  View.Sink(function(a)
  {
   var dir;
   if(a!=null&&a.$==1)
 ...
 FormaFirma.formaFirma=function(nombre,contenido,tipo,procesar,filenamePre)
 {
  ...
  }),(p=Handler.CompleteHoles(b.k,b.h,[["firmante",0],["fecha",0],["acepto",2]]),(i=new TemplateInstance.New(p[1],prozperProd$js_Templates.formafirma(p[0])),(b.i=i,i))));
  View.Sink(function(a)
  {
 ...
 Msal.getTokenO0=function()
 {
  ...
  return Concurrency.Delay(function()
  {
   ...
   return Msal.userO().Get()==null?(console.log("getTokenO0 (4): No user connected!"),Concurrency.Return(null)):Concurrency.TryWith(Concurrency.Delay(function()
   {
   ...
   }),function(a)
   {
    ...
    return Concurrency.TryWith(Concurrency.Delay(function()
    {
     ...
     {
      Msal.agent().f().handleRedirectCallback(function(error,resp)
      {
       try
       {
      ...
      return Msal.agent().f().acquireTokenRedirect(Msal.authParms());
     }),function(a$1)
     {
 ...
 Msal.authParms=function()
 {
  return AuthenticationParameters.New$1(null,null,null,null,null,null,null,null,{
   ...
   }))(Global.id))(Msal.tenantName()))(Msal.appId()),(((Runtime$1.Curried3(function($1,$2,$3)
   {
 ...
 SC$3.$cctor=function()
 {
  ...
  SC$3.serInt64=[Global.String,function(j)
  {
   return j.tryInt();
  }];
  ...
  SC$3.serTypedRegisters=new Dictionary.New$5();
  ...
  SC$3.originalProvider=Remoting.AjaxProvider();
  SC$3.getTokenOA=function()
  {
   var b;
   b=null;
   return Concurrency.Delay(function()
 ...
 Builder.New$1=Runtime$1.Ctor(function()
 {
  Obj.New.call(this);
 },Builder);
 ...
 EffBuilder.New$1=Runtime$1.Ctor(function()
 {
  Obj.New.call(this);
 },EffBuilder);
 ...
 Policy=Msal$1.Policy=Runtime$1.Class({
  toString:function()
  {
   return Strings.ReplaceChar(Library["String.get_toUnderscore$1"]((function($1)
   {
    return function($2)
    {
     return $1(prozperProd$js_GeneratedPrintf.p$1($2));
    };
   }(Global.id))(this)),"_"," ");
  }
 },null,Policy);
 ...
 Subscripcion=TypesV0.Subscripcion=Runtime$1.Class({
  get_Short:function()
  {
   return((((((Runtime$1.Curried(function($1,$2,$3,$4,$5,$6)
   {
 ...
 CuentaBancaria$1.formaDoc=function(ctaV)
 {
  ...
  forma=(b=(D=AttrModule.DynamicPred("disabled",disabledW,View.Const("")),(D$1=AttrModule.DynamicPred("disabled",disabledW,View.Const("")),(D$2=AttrModule.DynamicPred("disabled",disabledW,View.Const("")),(D$3=AttrModule.DynamicPred("disabled",disabledW,View.Const("")),(D$4=AttrModule.DynamicPred("disabled",disabledW,View.Const("")),(T$2=Doc.EmbedView(View.Map(VariousUI.crearOptions,VariousUI.tiposCta().get_View())),ProviderBuilder.Make().WithHole({
   ...
   $0:"disabled5",
   $1:D
  })),(p=Handler.CompleteHoles(b.k,b.h,[["tipocuenta",0],["titular",0],["numero",0],["banco",0],["routing",0]]),(i=new TemplateInstance.New(p[1],prozperProd$js_Templates.cuentabancaria(p[0])),(b.i=i,i))));
 ...
 {
  var disabledW,forma,b,V,D,D$1,D$2,D$3,D$4,M,A,T$2,p,i,requeridosW;
  ...
  },VariousUI.mesesV().get_View())),(A=Doc.EmbedView(View.Map(function($1)
  {
   ...
   $0:"visible",
   $1:V
  })),(p=Handler.CompleteHoles(b.k,b.h,[["tipotarjeta",0],["titular",0],["numero",0],["aniovenc",0],["mesvenc",0]]),(i=new TemplateInstance.New(p[1],prozperProd$js_Templates.tarjetacredito(p[0])),(b.i=i,i))));
  View.Sink(function($1)
  {
   return a($1[0],$1[1],$1[2]);
  },tarV.get_View());
 ...
 IdSubscription=TypesV0.IdSubscription=Runtime$1.Class({
  get_Id:function()
  {
   return this.$0;
  }
 ...
 {
  SC$11.$cctor();
  return SC$11.BatchUpdatesEnabled;
 };
 ...
 SC$11.$cctor=function()
 {
  ...
  SC$11.BatchUpdatesEnabled=true;
 };
...
//# sourceMappingURL=prozperProd.js.map
