...
(function()
{
 ...
 MainProgram.mainProgram=function()
 {
  ...
  {
   var b$1,p$1,i;
   return Unchecked.Equals(al.id,Aliado$2.empty().id)?(b$1=ProviderBuilder.Make(),(p$1=Handler.CompleteHoles(b$1.k,b$1.h,[]),(i=new TemplateInstance.New(p$1[1],prozperDes$js_Templates.opcionesadministrador(p$1[0])),(b$1.i=i,i)))).get_Doc():Doc.get_Empty();
  },ModeloUI.aliadoW());
...
//# sourceMappingURL=prozperDes.js.map
