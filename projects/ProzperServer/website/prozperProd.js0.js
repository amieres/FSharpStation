(function()
{
 ...
 EffBuilder=Eff.EffBuilder=Runtime.Class({
  ...
  TryFinally:function(body,compensation)
  {
   ...
   return Eff.op_BarGreaterGreater$1($1,compensation);
  },
  TryWith:function(body,handler)
  {
   return new Eff$1({
 ...
 FormaContrato.formaContrato=function()
 {
  ...
  return FormaFirma.formaFirma(nombreW,(b=ProviderBuilder.Make().WithHole({
   ...
   $0:"aliado",
   $1:nombreW
  }),(p=Handler.CompleteHoles(b.k,b.h,[]),(i=new TemplateInstance.New(p[1],prozperProd$js_Templates.contrato(p[0])),(b.i=i,i)))).get_Doc(),TypesV0.TipoArchivo.Contrato,FormaContrato.firmarContrato,"Contrato");
 };
 ...
 MainProgram.mainProgram=function()
 {
  ...
  {
   var b$1,p$1,i;
   return Unchecked.Equals(al.id,Aliado$1.empty().id)?(b$1=ProviderBuilder.Make(),(p$1=Handler.CompleteHoles(b$1.k,b$1.h,[]),(i=new TemplateInstance.New(p$1[1],prozperProd$js_Templates.opcionesadministrador(p$1[0])),(b$1.i=i,i)))).get_Doc():Doc.get_Empty();
  },ModeloUI.aliadoW());
