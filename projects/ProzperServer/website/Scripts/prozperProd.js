...
{
 "use strict";
 var Global,FsRoot,ProzperServer,ClientSide,MainProgram,WebSharper,Obj,UI,Var$1,LibraryJS,AppFramework,PlugIn,ModeloUI,Aliado,Operators,View,Var,Lazy,RenderAliados,RenderAliado,FormaRegistro,FormaDatos,FormaContactos,FormaFormasPago,ReporteConsolidado,TablaPagos,ListaDocs,FormaAutorizacion,FormaContrato,Transacciones,Pendientes,EventTarget,Node,JavaScript,JS,Unchecked,LayoutEngineModule,Option,TypesV0,Aliado$1,Aliado$2,Templating,Runtime,Server,TemplateInstance,Arrays,ProviderBuilder,Handler,ProzperServer_Templates,ProzperServer_GeneratedPrintf,ProzperServer_Router,Doc,Rpc,IdAliado,Modelo,ConcreteVar,Snap,SC$1,ListModel,PlugInVar,PlugInView,PlugInDoc,Pervasives,LazyExtensionsProxy,LazyRecord,Seq,Library,SortWith,Buscar,Collections,FSharpSet,Set,Strings,CorreoElectronico,DatosPersonales,CorreoElectronico$1,Telefono,Direccion,Monads,AsyncResultBuilder,Refresh,System,Guid,VariousUI,HtmlModule,attr,ViewBuilder,StatusAliado,List,CuentaBancaria,RoutingNumber,NumeroCuenta,Utils,FormaPago,Result,Archivo,Extensions,ListModel$1,Date,String,TipoArchivo,StatusArchivo,Blob,CuentaPago,FormaFirma,PremisasCalculo,PlugInAction,Msal,WindowOrWorkerGlobalScope,LayoutEngine,SC$2,IdForAuthorize,DatosPersonales$1,DiaPago,TipoAliado,Numeric,List$1,Dictionary,HashSet,Client,Abbrev,Async,Fresh,Builder,BuilderP,Eff,EffBuilder,AsyncResultBuilderP,Slice,ParseO,Serializer,Msal$1,Policy,Telefono$1,TipoTelefono,Direccion$1,TipoDireccion,Estado,Pais,ZonaPostal,TarjetaCredito,Expiracion,NumeroTarjeta,TipoTarjeta,TipoCuenta,Genero,Remoting,Configuration,AuthOptions,Control,MailboxProcessor,Mailbox,EndPoint,Router,Rpc0,IdPayment,PlugInQuery,FSharpMap,Enumerator,T,BalancedTree,T$1,AsyncResult,AjaxRemotingProvider,Array,Subscripcion,CuentaBancaria$1,TarjetaCredito$1,Object,FromView,Concurrency,AttrProxy,Array$1,Storage,AttrModule,GeneratedPrintf,LayoutEngine_Templates,LayoutEngine_GeneratedPrintf,WebComponent,WcTabStrip,WcTabStripT,WcSplitter,DictionaryUtil,CheckedInput,Client$1,Templates,DateUtil,SC$3,Pojo,Error,TimeoutException,Promise,Sitelets,RouterOperators,RouterModule,Route,MapUtil,Tree,IdAddress,IdSubscription,Docs,AsyncBody,CT,Attrs,DomUtility,SC$4,ArrayStorage,Var$2,ConceptoPago,Enlace,Layout,WcSplitterT,DocElemNode,CharacterData,SC$5,XhrProvider,FSharpEvent,LinkedList,AuthenticationParameters,Account,Router$1,List$2,Pair,Result$1,Scheduler,CancellationTokenSource,DynamicAttrNode,Measures,Hoverable,Hoverable$1,Event,UIEvent,ResizeObserver,SC$6,Elt,Attrs$1,Dyn,Prepare,An,Settings,Mailbox$1,HashSetUtil,Event$1,Event$2,NonStandardPromiseRejectionException,SC$7,Map,OperationCanceledException,Queue,SC$8,SC$9,AggregateException,KeyCollection,Updates,Docs$1,RunState,NodeSet,Anims,SC$10,Char,Json,FormatException,StringEncoding,String$1,SC$11,AppendList,LinkedListEnumerator,PathUtil,Easing,HashSet$1,DomNodes,SC$12,IntelliFactory,Runtime$1,Math,$,console,Date$1,JSON,Reflect,String$2;
 Global=self;
 ...
 ReporteConsolidado.consolidado=function()
 {
  ...
  function a(alid,fW)
  {
   ...
   }),(p$1=Handler.CompleteHoles(b$2.k,b$2.h,[["status",0],["influyente",0],["referido",0]]),(i$2=new TemplateInstance.New(p$1[1],ProzperServer_Templates.filaconsolidado(p$1[0])),(b$2.i=i$2,i$2)))).get_Doc();
  }
  ...
  },function()
  {
   ...
   $0:"tbody",
   $1:T$2
  })),(p=Handler.CompleteHoles(b$1.k,b$1.h,[["filtro",0]]),(i=new TemplateInstance.New(p[1],ProzperServer_Templates.consolidado(p[0])),(b$1.i=i,i)))).get_Doc();
 };
 ...
 ListaDocs.listaDocs=function()
 {
  ...
  return(b=(t=(T$2=Doc.EmbedView(View.Map(VariousUI.crearOptions,VariousUI.tiposAr().get_View())),(t$1=(T$3=ListModel$1.docLensMapView(Global.id,function(nm,arV)
  {
   ...
   }),(p$1=Handler.CompleteHoles(b$1.k,b$1.h,[]),(i$2=new TemplateInstance.New(p$1[1],ProzperServer_Templates.enlacedocumento(p$1[0])),(b$1.i=i$2,i$2)))).get_Doc();
   ...
   }),function(x)
   {
    ...
    $0:"disabled",
    $1:d
   })),(p$2=Handler.CompleteHoles(b$2.k,b$2.h,[["tipo",0],["status",0]]),(i$3=new TemplateInstance.New(p$2[1],ProzperServer_Templates.filadocs(p$2[0])),(b$2.i=i$3,i$3)))).get_Doc();
   ...
   return Concurrency.Delay(function()
   {
    return Concurrency.Bind(Pendientes.chequearStatusAliado(al,Rpc.obtenerListaDocs(al.id),Rpc.obtenerFormasDePagoId(al.id)),function(a)
    {
     ...
     return a.$==0&&Seq.isEmpty(a.$0)?Concurrency.Return(Doc.get_Empty()):a.$==1?Concurrency.Return(Doc.TextNode(a.$0)):Concurrency.Return((b$1=(p=Doc.Concat(Seq.map(Pendientes.pendiente,a.$0)),ProviderBuilder.Make().WithHole({
      ...
      $0:"pasos",
      $1:p
     })),(p$1=Handler.CompleteHoles(b$1.k,b$1.h,[]),(i=new TemplateInstance.New(p$1[1],ProzperServer_Templates.pendientes(p$1[0])),(b$1.i=i,i)))).get_Doc());
    });
   });
  },aliadoW));
 };
 ...
 Pendientes.enlaceArchivo=function(ar)
 {
  ...
  return(b=(n=(Pendientes.tarchivo2String(ar.tipo))[0][0],(i=ar.idAliado.get_Id(),ProviderBuilder.Make().WithHole({
   ...
   $0:"nombre",
   $1:n
  })),(p=Handler.CompleteHoles(b.k,b.h,[]),(i$1=new TemplateInstance.New(p[1],ProzperServer_Templates.enlacedocumento(p[0])),(b.i=i$1,i$1)))).get_Doc();
 };
  ...
  return Buscar.New(hijosDe,nivelDe,function(id)
  {
   ...
   catch(e)
   {
    return(function($1)
    {
     return function($2)
     {
      return $1("buscarAliado failed: "+ProzperServer_GeneratedPrintf.p$13($2));
     };
 ...
 ProzperServer_Templates.enlacedocumento=function(h)
 {
  Templates.LoadLocalTemplates("indexdes");
  return h?Templates.NamedTemplate("indexdes",{
   $:1,
 ...
 ProzperServer_Templates.pendientes=function(h)
 {
  Templates.LoadLocalTemplates("indexdes");
  return h?Templates.NamedTemplate("indexdes",{
   $:1,
 ...
 SC$1.$cctor=function()
 {
  ...
  SC$1.serInt64=[function($3)
  {
   return function($4)
   {
    return $3(Global.String($4));
   };
  ...
  SC$1.transaccionesW=View.MapAsync(function()
  {
   ...
   return Concurrency.Bind(Rpc.obtenerTransaccionesPara(Aliado.get_LoggedId()),(f$7=(d$1=[],function(r)
   {
  ...
  SC$1.i_diaPago=ReporteConsolidado.agregarCampo(10,true,function(al)
  {
   return Library["String.Right$1"]((function($3)
   {
    return function($4)
    {
     return $3(ProzperServer_GeneratedPrintf.p$2($4));
    };
 ...
 TipoTelefono=TypesV0.TipoTelefono=Runtime$1.Class({
  toString:function()
  {
   return(function($1)
   {
    return function($2)
    {
     return $1(ProzperServer_GeneratedPrintf.p$12($2));
    };
   }(Global.id))(this);
  }
 },null,TipoTelefono);
