...
(function()
{
   ...
   Strings.Trim(m)!==""?Global.alert(m):($1=datosOV.Get(),$2=correoOV.Get(),$3=telefonoOV.Get(),$4=direccionOV.Get(),$1!=null&&$1.$==1&&($2!=null&&$2.$==1&&($3!=null&&$3.$==1&&($4!=null&&$4.$==1&&($5=[$2.$0,$1.$0,$4.$0,$3.$0],true))))?(correo=$5[0],datos=$5[1],direccion=$5[2],telefono=$5[3],Rpc.iterA((b$1=Monads.asyncResult(),b$1.Run(b$1.Delay(function()
   {
    ...
    }),function(a)
    {
     ...
     Global.alert((function($6)
     {
      return function($7)
      {
       return $6(ProzperServer_GeneratedPrintf.p$12($7));
      };
     }(Global.id))(a));
     return b$1.Zero();
    });
   ...
   Strings.Trim(m)!==""?Global.alert(m):($1=datosOV.Get(),$2=View.TryGet(aliadoW),$1!=null&&$1.$==1&&($2!=null&&$2.$==1&&($3=[$2.$0,$1.$0],true))?(al=$3[0],datos=$3[1],Rpc.iterA((b$1=Monads.asyncResult(),b$1.Run(b$1.Delay(function()
   {
    ...
    }),function(a)
    {
     ...
     Global.alert((function($4)
     {
      return function($5)
      {
       return $4(ProzperServer_GeneratedPrintf.p$12($5));
      };
     }(Global.id))(a));
     return b$1.Zero();
    });
 ...
 FormaFormasPago.msg=function(a)
 {
  ...
  return idR.$==0?(function($1)
  {
   return function($2)
   {
    return $1("Cuenta verificada: "+ProzperServer_GeneratedPrintf.p$13($2));
   };
 ...
 ListaDocs.listaDocs=function()
 {
  ...
  function a(docName,docNameW)
  {
   ...
   return(b$1=(i$1=View.Map(function($1)
   {
    ...
    $0:"idaliado",
    $1:i$1
   })),(p$1=Handler.CompleteHoles(b$1.k,b$1.h,[]),(i$2=new TemplateInstance.New(p$1[1],ProzperServer_Templates.filadocs(p$1[0])),(b$1.i=i$2,i$2)))).get_Doc();
  }
 ...
 FormaAutorizacion.formaAutorizacion=function()
 {
  ...
  }))),(p=Handler.CompleteHoles(b.k,b.h,[["titular",0],["fecha",0],["acepto",2]]),(i=new TemplateInstance.New(p[1],ProzperServer_Templates.autorizacion(p[0])),(b.i=i,i))));
  View.Sink(function(a)
  {
   mensajes.Set(a);
  },View.Apply(View.Apply(View.Map2(function($1,$2)
  ...
  return Buscar.New(hijosDe,nivelDe,function(id)
  {
   ...
   catch(e)
   {
    return(function($1)
    {
     return function($2)
     {
      return $1("buscarAliado failed: "+ProzperServer_GeneratedPrintf.p$10($2));
     };
 ...
 ProzperServer_Templates.autorizacion=function(h)
 {
  Templates.LoadLocalTemplates("index0");
  return h?Templates.NamedTemplate("index0",{
   $:1,
 ...
 Rpc.obtenerUnions=function()
 {
  ...
  function f()
  {
   return(new AjaxRemotingProvider.New()).Async("ProzperServer:FsRoot.ProzperServer+Rpc.obtenerUnions:1877296388",[]);
  }
  b=Monads.asyncResult();
  return b.Run(b.Delay(function()
  {
 ...
 Rpc.obtenerListaDocs=function()
 {
  ...
  function f()
  {
   return(new AjaxRemotingProvider.New()).Async("ProzperServer:FsRoot.ProzperServer+Rpc.obtenerListaDocs:244796561",[Aliado.get_LoggedId()]);
  }
  b=Monads.asyncResult();
  return b.Run(b.Delay(function()
  {
 ...
 SC$1.$cctor=function()
 {
  var f,g,c,c$1,d,m,$1,c$2,c$3,f$1,f$2,b,b$1,b$2;
  ...
  {
   var clientId,authority,options;
   function tokenReceivedCallback(e,t,e$1,t$1,s)
   {
    Msal.callback(e,t,e$1,t$1,s);
   }
   clientId=Msal.applicationId();
   authority=Msal.authority();
   options=UserAgentApplication.Options(null,null,null,null,null,null,null,null,null,{
    $:1,
    $0:false
   },null,{
    $:1,
   ...
   return new self.Msal.UserAgentApplication(clientId,authority,function($2)
   {
 ...
 Msal.checkUser=function()
 {
  ...
  Concurrency.Start((b=null,Concurrency.Delay(function()
  {
   return Concurrency.Bind(Concurrency.Sleep(100),function()
   {
    ...
    {
     var newO,m;
     newO=(m=Msal.agent().f().getUser(),Unchecked.Equals(m,null)?null:{
      $:1,
      $0:m
     });
 ...
 Msal.getTokenO=function()
 {
  ...
  return Concurrency.Delay(function()
  {
   var m;
   m=Msal.userO().Get();
   return m==null?Concurrency.Return(null):Concurrency.Bind(Promise.AsAsync(Msal.agent().f().acquireTokenPopup([(((Runtime$1.Curried3(function($1,$2,$3)
   {
