...
{
 "use strict";
 var Global,WebSharper,UI,Array,String,List,Abbrev,Fresh,HashSet,Dict,Obj,Slot,Async,Mailbox,SC$1,AppendList,SC$2,DomUtility,SC$3,Trie,LookupResult,SC$4,Snap,Var,View,ConcreteVar,Updates,ViewBuilder,Submitter,Key,Model,Serializer,Storage,ArrayStorage,LocalStorageBackend,ListModel,ListModels,SC$5,ReactiveExtensions,DoubleInterpolation,Interpolation,Easing,Easings,An,Anims,Trans,SC$6,AnimatedAttrNode,DynamicAttrNode,AttrProxy,Client,Attrs,Dyn,Attrs$1,CheckedInput,AttrModule,SC$7,DocElemNode,Docs,DomNodes,NodeSet,RunState,Docs$1,Doc,Elt,EltUpdater,SC$8,Flow,FlowBuilder,HtmlModule,attr,Router,Route,Routing,RouteMap,Input,MousePosSt,MouseBtnSt,Mouse,KeyListenerSt,Keyboard,SC$9,List$1,Arrays,Enumerator,Strings,Char,Collections,HashSet$1,Seq,IntelliFactory,Runtime,Unchecked,console,Concurrency,Map,FSharpMap,Operators,Queue,Lazy,Dictionary,JSON,Numeric,Node,$,Slice,Sitelets,RouterModule,Route$1,Utils;
 Global=window;
 ...
 SC$8=Global.StartupCode$WebSharper_UI$Doc_Client=Global.StartupCode$WebSharper_UI$Doc_Client||{};
 ...
 SC$9=Global.StartupCode$WebSharper_UI$Input=Global.StartupCode$WebSharper_UI$Input||{};
 ...
 Var.MapLens=function(getKey,f,_var)
 {
 ...
 Docs$1.LocalTemplatesLoaded=function()
 {
  SC$8.$cctor();
  return SC$8.LocalTemplatesLoaded;
 };
 Docs$1.set_LocalTemplatesLoaded=function($1)
 {
  SC$8.$cctor();
  SC$8.LocalTemplatesLoaded=$1;
 };
 Docs$1.LoadedTemplateFile=function(name)
 {
  var m,o,d;
  m=(o=null,[Docs$1.LoadedTemplates().TryGetValue(name,{
   get:function()
   {
    return o;
   },
  ...
  return m[0]?m[1]:(d=new Dictionary.New$5(),(Docs$1.LoadedTemplates().set_Item(name,d),d));
 };
 ...
 {
  return o instanceof Doc?o:typeof o=="string"?Doc.TextNode(o):o instanceof Global.Element?Doc.Static(o):typeof o=="function"?Doc.EmbedView(View.Map(Doc.ToMixedDoc,o)):o instanceof Var?Doc.EmbedView(View.Map(Doc.ToMixedDoc,o.get_View())):Unchecked.Equals(o,null)?Doc.Empty():Doc.TextNode(Global.String(o));
 };
 ...
 Doc.Radio=function(attrs,value,_var)
 {
  ...
  return Elt.New(el,AttrProxy.Concat(List$1.append(List$1.ofArray([AttrProxy.Create("type","radio"),AttrProxy.Create("name",_var.get_Id()),valAttr]),List$1.ofSeq(attrs))),Doc.Empty());
 };
 ...
 {
  return Doc.Flatten(Var.MapLens(key,render,_var));
 };
 ...
 {
  var m,o;
  m=(o=null,[Docs$1.LoadedTemplateFile(baseName).TryGetValue(name==null?"":name.$0,{
   get:function()
   {
    return o;
   },
 ...
 Doc.LoadLocalTemplates=function(baseName)
 {
  ...
  existingLocalTpl=Docs$1.LoadedTemplateFile("");
  existingLocalTpl.count>0?Docs$1.LoadedTemplates().set_Item(baseName,existingLocalTpl):(function()
  {
  ...
  }(),Docs$1.LoadedTemplates().set_Item("",Docs$1.LoadedTemplateFile(baseName)));
 };
 Doc.LoadLocalTemplates$1=function()
 {
  if(!Docs$1.LocalTemplatesLoaded())
   {
    Docs$1.set_LocalTemplatesLoaded(true);
 ...
 {
  var els$1,i,$1,el,m;
  if(!Docs$1.LoadedTemplateFile(baseName).ContainsKey(name==null?"":name.$0))
   {
    els$1=els();
 ...
 Doc.PrepareTemplateStrict=function(baseName,name,els)
 {
   ...
   while(true)
    switch(recI)
    {
     case 0:
      ...
      name$3=p[1];
      baseName$1=p[0];
      if(!Docs$1.LoadedTemplates().ContainsKey(baseName$1))
       return console.warn("Instantiating non-loaded template",name$3);
      else
       {
        d=Docs$1.LoadedTemplates().get_Item(baseName$1);
  ...
  Docs$1.LoadedTemplateFile(baseName).set_Item(name$1,fakeroot);
 ...
 Doc.ChildrenTemplate=function(el,fillWith)
 {
  ...
  DomUtility.IterSelector(el,"[ws-onafterrender]",function(e$1)
  {
   ...
   m[0]?m[1].$==6?(e$1.removeAttribute("ws-onafterrender"),addAttr(e$1,AttrModule.OnAfterRender(m[1].$1))):console.warn("onafterrender hole filled with non-onafterrender data",name):void 0;
  });
  DomUtility.IterSelector(el,"[ws-var]",function(e$1)
  {
   ...
   m[0]?m[1].$==7?addAttr(e$1,AttrModule.Value(m[1].$1)):m[1].$==8?addAttr(e$1,AttrModule.Checked(m[1].$1)):m[1].$==9?addAttr(e$1,AttrModule.IntValue(m[1].$1)):m[1].$==10?addAttr(e$1,AttrModule.IntValueUnchecked(m[1].$1)):m[1].$==11?addAttr(e$1,AttrModule.FloatValue(m[1].$1)):m[1].$==12?addAttr(e$1,AttrModule.FloatValueUnchecked(m[1].$1)):console.warn("Var hole filled with non-Var data",name):void 0;
  });
 ...
 SC$8.$cctor=function()
 {
  ...
  SC$8.LocalTemplatesLoaded=false;
  SC$8.TextHoleRE="\\${([^}]+)}";
 };
 ...
 SC$9.$cctor=function()
 {
  ...
  SC$9.KeyListenerState=KeyListenerSt.New(Var.Create$1(List$1.T.Empty),false,Var.Create$1(-1));
