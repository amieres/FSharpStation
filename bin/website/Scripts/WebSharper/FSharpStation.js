(function()
{
 ...
 {
  return"FSharpStation1509672068131";
 };
 FsStationClient.New=Runtime.Ctor(function(clientId,fsStationId,timeout,endPoint)
 {
  this.fsIds=Option.defaultValue("FSharpStation1509672068131",fsStationId);
   ...
   if(m!=null&&m.$==1)
   {
    if(!Unchecked.Equals(m.$0[0].id,this.id))
     ...
     if(m!=null&&m.$==1)
      ...
      throw new MatchFailureException.New("Compiled\\FSharpStation2\\FSharpStation.fs",3058,18);
   }
   else
    void 0;
  },
 ...
 Layout=Template.Layout=Runtime.Class({
  ...
  ExportSetLayoutJson:function(name)
  {
   ...
   {
    $this.SetLayoutJson(a);
   };
  },
  SetLayoutJson:function(json)
  {
   try
   {
    function c(name,ldf)
  ...
  get_Render:function()
  {
   ...
   return new HtmlNode$1({
    ...
    {
     return $this.GetNode(Arrays.length(steps)===0?$this.main:(Seq.last(steps))[0],Template.processLayoutSteps(steps,$this.baseParts));
    },this.steps)
   });
  },
  GetNode:function(name,parts)
  {
   ...
   o=(o$1=Map.TryFind(name,parts),o$1==null?null:{
    $:1,
    $0:(a=o$1.$0,a.$==1?a.$0.get_Button().get_Render():a.$==2?Grid.NewBisect(a.$0,a.$1,a.$2,a.$3,$this.GetNode(a.$4,parts),$this.GetNode(a.$5,parts)).Min(a.$6).Max(a.$7).get_Render():a.$==3?(ts=TabStrip.New$1(Seq.map(function(node)
    {
     return[node,$this.GetNode(node,parts)];
    },a.$1)).SetTop(a.$0),(Template.addValue(name,ts,$this.tabStrips),ts.get_Render())):a.$0)
   });
 ...
 Layout.New$1=function(parts)
 {
  return Layout.New(new FSharpMap.New(parts),Var.Create$1([]),new Dictionary.New$5(),"main");
 };
 Layout.New=function(baseParts,steps,tabStrips,main)
 {
  return new Layout({
   baseParts:baseParts,
   steps:steps,
 ...
 {
  var o,o$1;
  o=(o$1=Seq.tryHead(steps),o$1==null?null:{
   $:1,
   $0:Template.processLayoutSteps(Seq.skip(1,steps),parts.Add(o$1.$0[0],o$1.$0[1]))
  });
  return o==null?parts:o.$0;
 };
 ...
 FableModule.fableTranslate=function(source)
 {
  ...
  return b.Delay(function()
  {
   ...
   return b.Bind$2((b$1=null,Concurrency.Delay(function()
   {
    ...
    {
     Global.CIPHERSpaceLoadFiles(["https://cdnjs.cloudflare.com/ajax/libs/require.js/2.3.2/require.min.js"],function()
     {
      var b$2;
 ...
 {
  var missingVar,currentCodeSnippetId,s,v,refresh,currentCodeSnippetO,position,s$1,v$1,noSelectionVal,propertyCssVal,v$2,f,g,prior,vw,propertyCssLinkVal,v$3,f$1,g$1,prior$1,vw$1,propertyModeVal,v$4,f$2,g$2,prior$2,vw$2,propertyThemeVal,v$5,f$3,g$3,prior$3,vw$3,propertyLayoutVal,v$6,f$4,g$4,prior$4,vw$4,propertyThemeLinkVal,disableParseVal,disableFSIVal,disableFableVal,disableWebSharperVal,lastCodeAndStarts,getPredecessorsM,codeFS,codeJS,parserMsgs,outputMsgs,parsed,dirty,draggedId,compileRunW,$1,fsStationClient,b,curPredecessors,topScrollList,fileName,fileInputElementId,loadFileElement,b$1,autoCompleteClient,parseFile,isParseDisabled,parseRun,rex1,rex2,rex,codeMirror,view,contentVar,changingIRefO,contentVarChanged,refVarChanged,codeMirrorRender,triggerWSResult,actLoadFile,actSaveFile,actAddSnippet,actDeleteSnippet,actIndentSnippet,actOutdentSnippet,actGetFsCode,actEvalCode,$2,actFableCode,$3,actRunWSNewTab,$4,actRunWSHere,$5,actRunWSIn,actParseCode,actCompileWS,$6,actFindDefinition,buttonsH,menuLeft,menuRight,menuBar,redraw,properties,s$2,v$7,v$8,snippetList,x,layout,view$1,contentVar$1,changingIRefO$1,contentVarChanged$1,refVarChanged$1,steps,x$1;
  ...
  function setPrior(v$9)
  {
   if(!Unchecked.Equals(prior[0].c,v$9))
    {
     Var.Set(prior[0],v$9);
     ((function($9)
     {
      return function($10)
      {
       return $9("New Value "+Utils.prettyPrint($10));
      };
     }(function(s$3)
     {
      console.log(s$3);
    ...
    ((function($9)
    {
     return function($10)
     {
      return $9("Same Value "+Utils.prettyPrint($10));
     };
    }(function(s$3)
    {
     console.log(s$3);
  ...
  function setPrior$1(v$9)
  {
   if(!Unchecked.Equals(prior$1[0].c,v$9))
    {
     Var.Set(prior$1[0],v$9);
     ((function($9)
     {
      return function($10)
      {
  ...
  function setPrior$2(v$9)
  {
   if(!Unchecked.Equals(prior$2[0].c,v$9))
    {
     Var.Set(prior$2[0],v$9);
     ((function($9)
     {
      return function($10)
      {
  ...
  function setPrior$3(v$9)
  {
   if(!Unchecked.Equals(prior$3[0].c,v$9))
    {
     Var.Set(prior$3[0],v$9);
     ((function($9)
     {
      return function($10)
      {
  ...
  function setPrior$4(v$9)
  {
   if(!Unchecked.Equals(prior$4[0].c,v$9))
    {
     Var.Set(prior$4[0],v$9);
     ((function($9)
     {
      return function($10)
      {
  ...
  function disablePropertyVal(p)
  {
   ...
   v$9=Val.map((f$7=(g$13=function(o)
   {
   ...
   prior$5=[Var.Create$1(null)];
   vw$5=Val.toView(v$9);
   View.Get(function(v$10)
   {
    ((function($9)
    {
     return function($10)
     {
      return $9("View Get "+Utils.prettyPrint($10));
     };
    }(function(s$3)
    {
     console.log(s$3);
  ...
  {
   var newM,$9,$10;
   return!msg?null:(newM=($9=_var.RVal(),($10=Global.String(msg),$9===null?$10:$9===""?$10:$10===null?$9:$10===""?$9:$9+"\n"+$10)),newM!==_var.RVal()?_var.set_RVal(newM):null);
  }
  ...
  {
   var p,others,moving,$9,$10,ti,tsn,a;
   function trySnippet(id)
   {
    function f$7(a$1,snp)
    {
     return Unchecked.Equals(snp.id,id);
    }
    return function(s$3)
    {
     return FsGlobal.tryPickI(function($11)
     {
      return f$7($11[0],$11[1]);
     },s$3);
    };
   }
   ...
   others=p[1];
   moving=p[0];
   $9=(trySnippet(fromId))(moving);
   $10=(trySnippet(toId))(others);
   $9!=null&&$9.$==1?$10!=null&&$10.$==1?(ti=$10.$0[0],tsn=$10.$0[1],a=Arrays.collect(Global.id,[Slice.array(others,{
    $:1,
    $0:0
   },{
    $:1,
     ...
     while(true)
      {
       if(i<0)
        ...
        if(f$7((x$2=(FsGlobal.codeSnippets())["var"].RVal(),(function(i$1)
        {
         return function(s$3)
         {
  ...
  function compileSnippetW(snpO)
  {
   var b$7;
   b$7=Wrap.wrapper();
   return b$7.Delay(function()
   {
    return b$7.Bind$1(Result.fromOption(ErrCompiler["Snippet Missing"],snpO),function(a)
    {
     var code;
     ...
     Var.Set(codeFS,code);
     return b$7.Bind$2(FsTranslator.translateAR(code,false),function(a$1)
     {
      return b$7.Bind$1(a$1,function(a$2)
      {
       var jsc;
       jsc=RunCode.completeJS(a$2);
       Var.Set(codeJS,jsc);
       addOutMsg("Compiled!");
       return b$7.Return(jsc);
      });
     });
    });
   });
  ...
  function evalWindowUrlJSW(url,js)
  {
   ...
   return b$7.Delay(function()
   {
    return b$7.Bind$1(Result.tryProtection(),function()
    {
     return b$7.Bind$1(newWindow(url),function(a)
     {
      focus(a);
      return b$7.Bind$2(Concurrency.Sleep(800),function()
      {
       return b$7.Return(_eval(a,js));
      });
     });
    });
   });
  ...
  function evalIFrameJSW(js)
  {
   ...
   return b$7.Delay(function()
   {
    return b$7.Bind$1(Result.tryProtection(),function()
    {
     return b$7.Bind$2(createIFrameA(),function(a)
     {
      var window$1;
      window$1=a.contentWindow;
      window$1.document.body.style.margin="0px";
      return b$7.Return(_eval(window$1,js));
     });
    });
   });
  }
  function compileRunUrlW(url,pos,snpO)
  {
   ...
   return b$7.Delay(function()
   {
    return b$7.Bind$3(compileSnippetW(snpO),function(a)
    {
     Var.Set(outputMsgs,"Running JavaScript...");
     return b$7.Bind$3(pos.$==3?evalWindowUrlJSW(url,a):evalIFrameJSW(a),function(a$1)
     {
      addOutMsg(a$1);
      addOutMsg("Done!");
      return b$7.Return([pos,a$1]);
     });
    });
   });
  }
  ...
  function listEntry(isParent,isExpanded,code)
  {
   ...
   {
    return Unchecked.Equals(x$2,y);
   }),currentCodeSnippetId)),HtmlNode.classIf("direct-predecessor",Val.map(($9=code.id,function($11)
   {
    return isDirectPredecessor($9,$11);
   }),currentCodeSnippetO)),HtmlNode.classIf("indirect-predecessor",Val.map(($10=code.id,function($11)
   {
    return isIndirectPredecessor($10,$11);
   ...
   }),HtmlNode.title(isParent?isExpanded?"collapse":"expand":""),HtmlNode.htmlText(isParent?isExpanded?"-":"+":"")]),HtmlNode.div([HtmlNode["class"]("code-editor-list-text"),HtmlNode.style1("text-indent",(x$3=(FsGlobal["CodeSnippet.get_Levels"](code))[0],(function($11)
   {
    return function($12)
    {
     return $11(Global.String($12)+"em");
    };
   }(Global.id))(x$3))),HtmlNode.style("white-space: pre"),HtmlNode.htmlText(Val.map2(function(n)
   {
    ...
    $0:AttrModule.Handler("click",function()
    {
     return function()
     {
      return Val.iter(function($11)
      {
       return togglePredecessorForCur(code,$11);
      },currentCodeSnippetO);
     };
    })
   }),HtmlNode.htmlText("X")])]);
  }
  function ifUndef(def,v$9)
  {
   return!v$9?def:v$9;
  }
  ...
  function obj2Map(o)
  {
   ...
   return!o?dict:(Seq.iter(function($9)
   {
    return a($9[0],$9[1]);
   },Arrays.map(function($9)
   {
    return m($9[0],$9[1]);
   },JSModule.GetFields(o))),dict);
  }
  function deserializeCodeSnipets(v$9)
  {
   var objs;
   try
   {
  ...
  function deleteCode()
  {
   var o,snp;
   o=CodeSnippet$1.FetchO(currentCodeSnippetId.c);
   o==null?void 0:(snp=o.$0,Global.confirm((function($9)
   {
    return function($10)
    {
     return $9("Do you want to delete "+Utils.toSafe($10)+"?");
    };
  ...
  function justFileName(f$7)
  {
   return Seq.last(Strings.SplitChars(f$7,["/","\\"],0));
  }
  function loadTextFile(element,f$7)
  {
   var files,reader;
   files=element.files;
   return files.length>0?(reader=new Global.FileReader(),(reader.onload=function(e)
   {
    return f$7(e.target.result);
  ...
  {
   var p,$9,alp,preds,red,cur,red1,t;
   p=lastCodeAndStarts!=null&&lastCodeAndStarts.$==1&&((alp=lastCodeAndStarts.$0[1],Unchecked.Equals(lastCodeAndStarts.$0[0],snp.id)&&Unchecked.Equals(alp,addLinePrepos))&&($9=[lastCodeAndStarts.$0[1],lastCodeAndStarts.$0[0],lastCodeAndStarts.$0[2]],true))?(msgF("Reparsing..."),[$9[2],FsGlobal["CodeSnippet.get_PrepareSnippet"](snp)]):(msgF("Parsing..."),preds=FsGlobal["CodeSnippet.Predecessors"](snp),red=CodeSnippet.ReducedCode(addLinePrepos,Slice.array(preds,{
    $:1,
    $0:0
   },{
    $:1,
  ...
  function parseFSA(silent)
  {
   ...
   return Concurrency.Delay(function()
   {
    ...
    return m!=null&&m.$==1?(runN=parseRun+1,(parseRun=runN,p=getCodeAndStartsFast(silent?Global.ignore:function(txt)
    {
     Var.Set(parserMsgs,txt);
    },m.$0,false),parsed=true,Concurrency.Bind(autoCompleteClient.Parse$1(parseFile,p[0],p[1]),function(a)
    {
  ...
  {
   var b$7;
   Concurrency.Start((b$7=null,Concurrency.Delay(function()
   {
    return Concurrency.Bind(isParseDisabled,function(a)
    {
     var m,cur;
     return a?Concurrency.Zero():(m=CodeSnippet$1.FetchO(currentCodeSnippetId.c),m!=null&&m.$==1?(cur=m.$0,Concurrency.Bind(parseIfMustThen(false),function()
     {
      ...
      {
       var c;
       addPrsMsg(((((c=(Runtime.Curried(function($9,$10,$11,$12,$13)
       {
        return $9("InfoFSharp \""+Utils.toSafe($10)+" "+("("+Utils.prettyPrint($11[0])+", "+Utils.prettyPrint($11[1])+")")+" - "+("("+Utils.prettyPrint($12[0])+", "+Utils.prettyPrint($12[1])+")")+" "+Utils.toSafe($13)+" \"");
    ...
    return Concurrency.Bind(isParseDisabled,function(a$1)
    {
     ...
     return a$1?Concurrency.Zero():(m=CodeSnippet$1.FetchO(currentCodeSnippetId.c),m!=null&&m.$==1?(cur=m.$0,Concurrency.Bind(parseIfMustThen(true),function()
     {
      ...
      return Concurrency.Bind(autoCompleteClient.Complete(parseFile,l,pos.line+1,pos.ch+1,cur.get_NameSanitized()),function(a$2)
      {
       ...
       cb(HintResponse.New(Arrays.map(function($9)
       {
        return m$1($9[0],$9[1],$9[2],$9[3]);
  ...
  function getAnnotations(txt,cb,a,ed)
  {
   ...
   Concurrency.Start((b$7=null,Concurrency.Delay(function()
   {
    ...
    return m!=null&&m.$==1?(cur=m.$0,Concurrency.Bind(parseIfMustThen(false),function()
    {
     ...
     cb(Arrays.choose(function($9)
     {
      return c($9[0],$9[1],$9[2],$9[3],$9[4],$9[5],$9[6],$9[7],$9[8]);
     },Arrays.choose(function(v$9)
     {
      var $9,a$2,t,$10,a$3,t$1,fc,fl;
      return(a$2=Useful.REGEX(rex2,"",v$9),a$2!=null&&a$2.$==1&&((t=a$2.$0,t&&Arrays.length(t)===13)&&($9=[Arrays.get(a$2.$0,8),Arrays.get(a$2.$0,5),Arrays.get(a$2.$0,7),Arrays.get(a$2.$0,2),Arrays.get(a$2.$0,4),Arrays.get(a$2.$0,11),Arrays.get(a$2.$0,1),Arrays.get(a$2.$0,10),Arrays.get(a$2.$0,9)],true)))?{
       $:1,
       $0:[$9[1],$9[4],Global.Number($9[2]),Global.Number($9[0]),Global.Number($9[8]),Global.Number($9[7]),$9[6],$9[3],$9[5]]
      }:(a$3=Useful.REGEX(rex1,"",v$9),a$3!=null&&a$3.$==1&&((t$1=a$3.$0,t$1&&Arrays.length(t$1)===8)&&($10=[Arrays.get(a$3.$0,4),Arrays.get(a$3.$0,2),Arrays.get(a$3.$0,3),Arrays.get(a$3.$0,1),Arrays.get(a$3.$0,6),Arrays.get(a$3.$0,5)],true)))?(fc=$10[0],(fl=$10[2],{
       $:1,
       $0:[$10[1],$10[3],Global.Number(fl),Global.Number(fc)-1,Global.Number(fl),Global.Number(fc),$10[5],"fsi",$10[4]]
      })):null;
  ...
  {
   var b$7;
   return Concurrency.Start((b$7=null,Concurrency.Delay(function()
   {
    var o;
  ...
  function gotoDefinition()
  {
   ...
   Concurrency.Start((b$7=null,Concurrency.Delay(function()
   {
    ...
    {
     var decl;
     return a.$==9?(decl=a.$0,(jumpToLine(((((((Runtime.Curried(function($9,$10,$11,$12,$13,$14)
     {
      return $9(Utils.toSafe($10)+" ("+Global.String($11)+", "+Global.String($12)+") - ("+Global.String($13)+", "+Global.String($14)+")");
     },6))(Global.id))(decl.File))(decl.Line))(decl.Column))(decl.Line))(decl.Column)),Concurrency.Zero())):a.$==1?(Global.alert((function($9)
     {
      return function($10)
      {
       return $9(GeneratedPrintf.p($10));
      };
     }(Global.id))(a.$0)),Concurrency.Zero()):(Global.alert((function($9)
     {
      return function($10)
      {
       return $9(FSharpStation_GeneratedPrintf.p$3($10));
      };
     }(Global.id))(a)),Concurrency.Zero());
    })))):Concurrency.Zero()):Concurrency.Zero();
   })),null);
  }
  function DoW(f$7,p,a,a$1)
  {
   var x$2;
   return Wrap.start(addOutMsg,(x$2=f$7(p),(Wrap.map(Global.ignore))(x$2)));
  }
  function DoP(f$7,p,a,a$1)
  {
   function p$1($9,$10)
   {
    if($9==null)
  ...
  function g$10(snpO)
  {
   ...
   return b$7.Delay(function()
   {
    return b$7.Bind$1(Result.fromOption(ErrCompiler["Snippet Missing"],snpO),function(a)
    {
     ...
     code=FsGlobal["CodeSnippet.GetCodeFsx"](a,true);
     Var.Set(codeFS,code);
     return b$7.Bind$2(FsEvaluator.evaluateAR(code),function(a$1)
     {
      return b$7.Bind$1(a$1,function(a$2)
      {
       addOutMsg(a$2);
       addOutMsg("Done!");
       return b$7.Return(a$2);
      });
     });
    });
   });
  ...
  function g$11(snpO)
  {
   ...
   return b$7.Delay(function()
   {
    ...
    {
     var code;
     Var.Set(outputMsgs,"Running Fable...");
     code=FsGlobal["CodeSnippet.GetCodeFsx"](a,false);
     Var.Set(codeFS,code);
     return b$7.Bind$3(FableModule.fableTranslate(code),function(a$1)
     {
      Var.Set(codeJS,a$1);
      Global["eval"](a$1);
      addOutMsg("Done!");
  ...
  function $8()
  {
   ...
   {
    lastCodeAndStarts=null;
    return b$7.Bind$2(parseFSA(false),function()
    {
     return b$7.Return();
    });
   });
  ...
  function jumpToRef(e,a)
  {
   ...
   return jumpToLine(Seq.pick(function($9)
   {
    return c($9[0],$9[1],$9[2]);
  ...
  function varSplitter(ver,pc,ch1,ch2,min,max)
  {
   return{
    $:2,
    $0:true,
  ...
  {
   Global.localStorage.setItem(s,JSON.stringify((FSharpStation_JsonEncoder.j$1())(v$9)));
  },currentCodeSnippetId);
  ...
  Val.sink(function(v$9)
  {
   Global.localStorage.setItem(s$1,JSON.stringify((FSharpStation_JsonEncoder.j$2())(v$9)));
  },position);
  ...
  {
   return g$5(f(x$2));
  }),currentCodeSnippetId),(prior=[Var.Create$1(null)],(vw=Val.toView(v$2),(View.Get(function(v$9)
  {
   ((function($9)
   {
    return function($10)
   ...
   setPrior(v$9);
  },vw),View.Sink(setPrior,vw),new Val({
   $:1,
   $0:prior[0]
  })))));
  ...
  {
   return g$6(f$1(x$2));
  }),currentCodeSnippetId),(prior$1=[Var.Create$1(null)],(vw$1=Val.toView(v$3),(View.Get(function(v$9)
  {
   ((function($9)
   {
    return function($10)
   ...
   setPrior$1(v$9);
  },vw$1),View.Sink(setPrior$1,vw$1),new Val({
   $:1,
   $0:prior$1[0]
  })))));
  ...
  {
   return g$7(f$2(x$2));
  }),currentCodeSnippetId),(prior$2=[Var.Create$1(null)],(vw$2=Val.toView(v$4),(View.Get(function(v$9)
  {
   ((function($9)
   {
    return function($10)
   ...
   setPrior$2(v$9);
  },vw$2),View.Sink(setPrior$2,vw$2),new Val({
   $:1,
   $0:prior$2[0]
  })))));
  ...
  {
   return g$8(f$3(x$2));
  }),currentCodeSnippetId),(prior$3=[Var.Create$1(null)],(vw$3=Val.toView(v$5),(View.Get(function(v$9)
  {
   ((function($9)
   {
    return function($10)
   ...
   setPrior$3(v$9);
  },vw$3),View.Sink(setPrior$3,vw$3),new Val({
   $:1,
   $0:prior$3[0]
  })))));
  ...
  {
   return g$9(f$4(x$2));
  }),currentCodeSnippetId),(prior$4=[Var.Create$1(null)],(vw$4=Val.toView(v$6),(View.Get(function(v$9)
  {
   ((function($9)
   {
    return function($10)
   ...
   setPrior$4(v$9);
  },vw$4),View.Sink(setPrior$4,vw$4),new Val({
   $:1,
   $0:prior$4[0]
  })))));
  propertyThemeLinkVal=Val.map(function($9)
  {
   return function($10)
   {
    return $9("/EPFileX/codemirror/content/theme/"+Utils.toSafe($10)+".css");
   };
  ...
  disableFableVal=Val.map2(function(e)
  {
   return function(e$1)
   {
    return e||e$1;
  ...
  disableWebSharperVal=Val.map2(function(e)
  {
   return function(e$1)
   {
    return e||e$1;
  ...
  Val.sink(function($9)
  {
   return function($10)
   {
    return $9("disableFSIVAl = "+Utils.prettyPrint($10));
   };
  }(function(s$3)
  {
   console.log(s$3);
  ...
  loadFromUri!==""?Concurrency.Start((b$1=null,Concurrency.Delay(function()
  {
   return Concurrency.Bind(Concurrency.Sleep(3000),function()
   {
    ...
    ((function($9)
    {
     return function($10)
     {
      return $9("loading "+Utils.toSafe($10)+"...");
     };
    }(function(s$3)
    {
     console.log(s$3);
  ...
  {
   var $9;
   lastCodeAndStarts!=null&&lastCodeAndStarts.$==1&&(Unchecked.Equals(lastCodeAndStarts.$0[0],currentCodeSnippetId.c)&&($9=[lastCodeAndStarts.$0[0],lastCodeAndStarts.$0[2]],true))?setDirtyPart():setDirty();
  }).OnRender(function(ed)
  {
   ed.addKeyMap(KeyMapAutoComplete.New(showToolTip,showToolTip,function(a)
   {
    Template.showHints(ed,function($9)
    {
     return getHints($9[0],$9[1],$9[2]);
    },false,a);
   }));
   Template.setLint(ed,function($9)
   {
    return getAnnotations($9[0],$9[1],$9[2],$9[3]);
   });
   Val.sink(function(v$9)
   {
    var b$7;
  ...
  actLoadFile=Action.New$1("Load...").OnClick(function($9)
  {
   return function($10)
   {
    return do_LoadFile($9,$10);
   };
  });
  ...
  actEvalCode=Action.New$1("Run FSI").OnClick(($2=function(x$2)
  {
   return g$10(getSnpO(x$2));
  },Runtime.Curried(DoW,2,[$2,null]))).Disabled(disableFSIVal);
  actFableCode=Action.New$1("Run Fable").OnClick(($3=function(x$2)
  {
   return g$11(getSnpO(x$2));
  },Runtime.Curried(DoW,2,[$3,null]))).Disabled(disableFableVal);
  actRunWSNewTab=Action.New$1("Run WebSharper in new tab").OnClick(($4=Position.NewBrowser,Runtime.Curried(DoW,2,[compileRunP,$4]))).Disabled(disableWebSharperVal);
  actRunWSHere=Action.New$1("Run WebSharper in WS Result").OnClick(($5=Position.Below,Runtime.Curried(DoP,2,[compileRunP,$5]))).Disabled(disableWebSharperVal);
  actRunWSIn=Action.New$1("Run WebSharper in ...").OnClick(Runtime.Curried(DoP,2,[$7,null])).Disabled(disableWebSharperVal);
  actParseCode=Action.New$1("Parse F#").OnClick(Runtime.Curried(DoW,2,[$8,null])).Disabled(disableParseVal);
  actCompileWS=Action.New$1("Compile WebSharper").OnClick(($6=function(x$2)
  {
   return compileSnippetW(getSnpO(x$2));
  },Runtime.Curried(DoW,2,[$6,null]))).Disabled(disableWebSharperVal);
  ...
  buttonsH=HtmlNode.div([actAddSnippet.get_Button().get_Render(),actOutdentSnippet.get_Button().get_Render(),actIndentSnippet.get_Button().get_Render(),loadFileElement.get_Render().AddChildren([HtmlNode.style("grid-column: 4/6")]),actEvalCode.get_Button().get_Render(),actFableCode.get_Button().get_Render(),actRunWSIn.get_Button().get_Render(),actDeleteSnippet.get_Button().get_Render(),actFindDefinition.get_Button().get_Render(),HtmlNode.span([]),actSaveFile.get_Button().get_Render(),HtmlNode.span([]),actGetFsCode.get_Button().get_Render(),actParseCode.get_Button().get_Render(),HtmlNode.someElt(Doc.Select([AttrProxy.Create("id","Position")],function(v$9)
  {
   return v$9.$==1?"Right":v$9.$==2?"In Tab":v$9.$==3?"New Browser":"Below";
  },List.ofArray([Position.NewBrowser,Position.Below]),position)),HtmlNode.style("\n                    overflow: hidden;\n                    display: grid;\n                    grid-template-columns: repeat(8, 12.1%);\n                    bxackground-color: #eee;\n                    padding : 5px;\n                    grid-gap: 5px;\n                ")]);
  menuLeft=Menu.New2([MenuEntry.New$2("File").SubMenu([actLoadFile.get_MenuEntry(),actSaveFile.get_MenuEntry()]),MenuEntry.New$2("Code").SubMenu([actAddSnippet.get_MenuEntry(),actDeleteSnippet.get_MenuEntry(),MenuEntry.New$2("").get_Divider(),actIndentSnippet.get_MenuEntry(),actOutdentSnippet.get_MenuEntry(),MenuEntry.New$2("").get_Divider(),actFindDefinition.get_MenuEntry(),MenuEntry.New$2("").get_Divider(),actGetFsCode.get_MenuEntry()]),MenuEntry.New$2("Run").SubMenu([actEvalCode.get_MenuEntry(),actFableCode.get_MenuEntry(),MenuEntry.New$2("").get_Divider(),actRunWSNewTab.get_MenuEntry(),actRunWSHere.get_MenuEntry(),MenuEntry.New$2("").get_Divider(),actParseCode.get_MenuEntry(),actCompileWS.get_MenuEntry()])]);
  ...
  v$7=SplitterBar.New$1(20).Children([HtmlNode.style("grid-row: 2 / 4")]).get_Var();
  v$8=Global.localStorage.getItem(s$2);
  v$8!==null?v$7.set_RVal(((Provider.Id())())(JSON.parse(v$8))):void 0;
  Val.sink(function(v$9)
  {
   Global.localStorage.setItem(s$2,JSON.stringify(((Provider.Id())())(v$9)));
  },v$7);
  ...
  steps=List.ofArray([["messagesR",{
   ...
   $:3,
   $0:true,
   $1:["Output","Parser","JavaScript","F# code","WS Result"]
  }],["title_code",fixedHorSplitter(true,34,"title","code")],["code_props",varSplitter(true,85,"title_code","messagesR",25,100)],["code_buttons",fixedHorSplitter(false,80,"code_props","buttons")],["snippets_code",varSplitter(true,15,"snippets","code_buttons",5,95)],["main_messages",varSplitter(false,82,"snippets_code","messagesB",35,100)],["main_window",fixedHorSplitter(true,50,"menu","main_messages")]]);
  Val.sink(function(json)
  {
   if(json==="")
    layout.SetLayout(steps);
   else
