...
namespace FSSGlobal
  ...
  // Code to be evaluated using FSI: `Evaluate F#`
    ...
    module Useful =
      ...
      # 1 @"(6)657c8f34-c917-4659-825d-c9ead206efcf swap.fsx"
    ...
    module UsefulDotNet =
      # 1 @"(6)f930dc48-39e8-453c-8c77-18a2cd73637a ResourceAgent.fsx"
      open Useful
      ...
      # 1 @"(6)4137cad8-fd64-426e-98de-16a92a56388d TempFileName.fsx"
    ...
    # 1 @"(4)a70b4838-75d6-40c3-9a0c-5bd03c57cce5 FsEvaluator.fsx"
    module FsEvaluator =
      # 1 @"(6)2f12f36b-fde1-48ab-ab97-0d3ca54021cb evalFsiExe.fsx"
      open Useful
    ...
    module FsTranslator =
      # 1 @"(6)96f91fe1-3aa2-4aa0-b04f-b428fd2f0948 TranslatorCaller.fsx"
      ...
      # 1 @"(6)95a237c8-a9ff-40d1-bd72-bd298b20af8c translateAR.fsx"
      open Useful
      open WebSharper
    ...
    # 1 @"(4)b6577554-e62e-41ed-983e-d4dd12e3512f FSAutoCompleteIntermediary.fsx"
    module FSAutoCompleteIntermediary =
    
      # 1 @"(6)319e0842-b83e-4036-9f57-602ca4a30ac5 FSAutocompleteCall.fsx"
      //#r @"..\packages\FSharp.Data\lib\net40\FSharp.Data.dll"
      //#r @"..\packages\FSharp.Data\lib\net40\FSharp.Data.DesignTime.dll"
      //#r @"..\packages\NewtonSoft.JSon\lib\net45\NewtonSoft.JSon.dll"
      ...
      # 1 @"(6)466e6783-0751-48d5-b79b-165aaa7d2173 FSAutoCompleteIntermediaryClient.fsx"
      open Useful
  ...
  *)
    ...
    module HtmlNode      =
      ...
      *)
      ...
      # 1 @"(6)336d6f19-0c57-4af9-8716-1b3fbf6b112c storeVar.fsx"
      [< Inline >]
    ...
    module Template      =
      ...
      # 1 @"(6)5878287a-a18f-4c71-b086-bd6e146270a1 ResizeObserver.fsx"
      ...
      # 1 @"(6)f3c86328-e5b6-4ef1-a3d9-d82098f4ffe2 MenuBar.fsx"
      ...
      # 1 @"(6)8346ae00-dde8-4368-acad-f8cca1164ff6 Action.fsx"
      type Action = {
          text       : Val<string>
          highlight  : Val<bool>
          disabled   : Val<bool>
    ...
    [<JavaScript>]
    module RunCode       =
      # 1 @"(6)afaac2af-143d-4745-9447-7e8d3044950f completeJS.fsx"
      let completeJS js = 
        """
    ...
    # 1 @"(4)529e1429-a4ce-48be-a89f-f13fec19bef3 FSharpStation Code.fsx"
    module FSharpStation =
    
      # 1 @"(6)1787d1fe-db11-4716-b3f6-164048e8991b CodeSnippet Extensions, Position.fsx"
      open Template
      open FsStationShared
      ...
      open FsGlobal                
      # 1 @"(6)c2188026-a06a-4963-a95a-93075e5f5b6e FSharpStationClient.fsx"
      [< JavaScript >]
      let FSharpStationClient () =
      
        # 1 @"(8)987560b0-1fe6-4835-ad99-aed93db7da1a currentCodeSnippetId.fsx"
        ...
        # 1 @"(8)07e477d3-fb6e-4c83-bb89-b4b2cce55d7b CodeEditorMain.fsx"
        ...
        # 1 @"(8)3f2ec5e2-8ab6-4e5b-bb89-1943ed3a4964 Compile.fsx"
        ...
        # 1 @"(8)95ca1e9f-4029-4fc1-8b1c-ab12db71c90b Messaging.fsx"
        #if NOMESSAGING
        #else
        ...
        #endif
        # 1 @"(8)93f32df7-da8b-472f-8bad-e82cc58ec52b List Code.fsx"
        ...
        ()    
        # 1 @"(8)54304360-819a-498c-a091-e6ece880a35a Deserialize.fsx"
        ...
        let deserializeCodeSnipets v = 
            try
                ...
                snps
            with _ -> [||]
        # 1 @"(8)60191ea0-da20-4fbf-96b8-3871338a66d8 Add,Delete,Load,Save.fsx"
        let addCode   ()   =
            CodeSnippet.PickIO currentCodeSnippetId.Value
        ...
        ()
        # 1 @"(8)47f7c0ba-35b0-466e-a759-4e4d9963e524 codeMirror.fsx"
        ...
        # 1 @"(8)fa5b4506-b26d-4387-8e04-ac7a5a90861a style.fsx"
        let styleEditor    =
             """
        div textarea {
        ...
        .body    { margin         : 0px                 }
            """
        # 1 @"(8)70bc3916-4714-4ee1-a2d0-d3917eeadf9d Actions.fsx"
        ...
        ()           
        # 1 @"(8)75c3d033-99b5-409f-8ecb-cd9bd8b101ab CodeEditorGrid.fsx"
        ...
        *)
        ()
        # 1 @"(8)8ee8705a-f115-437e-8d7d-418773f3c6d4 MainForm.fsx"
        let snippetList = 
            codeSnippets.View
               |> View.SnapshotOn codeSnippets.Value refresh.View
               |> bindHElem listEntries
      ...
      # 1 @"(6)b9ca9697-6cb4-4085-b509-9f702a62086f Site.fsx"
      ...
      # 1 @"(6)0dbfcc9d-8ea2-42a3-8f81-ce2bf7d0fad4 FSharpStation.fsx"
      //#r @"..\packages\Owin\lib\net40\Owin.dll"
      //#r @"..\packages\Microsoft.Owin\lib\net45\Microsoft.Owin.dll"
      //#r @"..\packages\Microsoft.Owin.Hosting\lib\net45\Microsoft.Owin.Hosting.dll"
      //#r @"..\packages\Microsoft.Owin.Host.HttpListener\lib\net45\Microsoft.Owin.Host.HttpListener.dll"
