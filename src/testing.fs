////-d:FSharpStation1551903608592 -d:WEBSHARPER
    ...
    open WebSharper
        ...
        module TestingJS =
            ...
            module Date =
                ...
                let testCases = 
                    [
                    "DateTime(Y,M,D)"       , fun()-> ParseO.parseDateO2 "2019-03-08" |>! print = (System.DateTime(2019, 3, 8) |>! print |> Some)
                    "toYYYYMMDD roundtrip"  , fun()-> ParseO.parseDateO2 "2019-03-08" |>! print |> Option.map (Date.toYYYYMMDD "-") |>! print = Some "2019-03-08"
                    ]
                ...
                let main() =
                    let results =
                        testCases
                        |> Seq.map (fun (name, f) -> name, try f() |> Ok with e -> printfn "%A" e ; Result.Error e)
                    div [] [
                        h1  [] [ text "parseDateO2" ]
                        h3  [] [ text "Test Cases" ]
                        h4 [] [
