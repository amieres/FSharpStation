...
#nowarn "1178"
#nowarn "1182"
////-d:FSharpStation1545749998472 -d:WEBSHARPER
...
namespace FsRoot
    ...
    module Markdown =
        ...
        module Log =
          ...
          let infof  f = printfn f
          let errorf f = printfn f
          let warnf  f = printfn f
          let critf  f = printfn f
          let verbf  f = printfn f
        module Common =
        ...
        module Patterns =
            ...
            let (|ParseCommands|_|) (str:string) = 
              ...
              if allKeysValid && kvs = [] then None else
              let dic = Dictionary<_,_>()
              kvs |> Seq.iter dic.Add
              Some dic
            ...
            let [< Inline >] (|Command|_|) k (d:Dictionary<_, _>) =
        ...
        module PlugIns =
            ...
            module MarkdownPlugIn =
                ...
                let main() =
                    ...
                    //            } |> Async.Start
                    //    ))
                    let callMarkdown = Markdown.TransformHtml >> htmlV.Set
